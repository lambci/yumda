...
echo "%exclude %{ghclibdir}/package.conf.d" >> ghc-base.files
...
for filelist in delete.files ghc*devel.files; do
  awk '{print "%{buildroot}"$1}' ${filelist} | xargs rm -rf
done

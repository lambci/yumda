...
%global dbus_common_config_opts --enable-libaudit --enable-selinux=yes --with-init-scripts=redhat --with-dbus-user=dbus --libexecdir=%{_libexecdir}/dbus-1
...
# ltmain.sh
%configure %{dbus_common_config_opts} --disable-asserts
make distclean
...
install --directory %{buildroot}%{_localstatedir}/lib/dbus

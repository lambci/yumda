...
%exclude %{_jvmdir}/%{sdkdir %{nil}}/src.zip
%exclude %{_jvmdir}/%{jredir %{nil}}/bin/policytool
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/%{archinstall}/libatk-wrapper.so
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/ext/java-atk-wrapper.jar
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/accessibility.properties
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/%{archinstall}/libawt_xawt.so
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/%{archinstall}/libjawt.so
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/%{archinstall}/libjsoundalsa.so
%exclude %{_jvmdir}/%{jredir %{nil}}/lib/%{archinstall}/libsplashscreen.so


%changelog
* Tue Jul 30 2019 Michael Hart <michael@lambci.org>

...
rm glib/pcre/*.[ch]
%configure --disable-silent-rules --with-pcre=system --disable-systemtap --disable-static --disable-installed-tests --disable-introspection
...
# installs.
touch -r gio/gdbus-2.0/codegen/config.py.in %{buildroot}/%{_datadir}/glib-2.0/codegen/config.py
...
%exclude %{_libdir}/glib-2.0
%exclude %{_libdir}/gio/modules/*.la
%exclude %{_libdir}/gio/modules/*.so
...
%exclude %{_datadir}/glib-2.0/gettext
%exclude %{_datadir}/glib-2.0/codegen
%exclude %{_datadir}/glib-2.0/schemas/gschema.dtd
%exclude %{_datadir}/glib-2.0/valgrind/glib.supp

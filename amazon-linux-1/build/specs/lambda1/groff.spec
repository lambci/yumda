...
%exclude %{_datadir}/%{name}/%{version}/font/devpdf/
%exclude %{_datadir}/%{name}/%{version}/groffer/
%exclude %{_datadir}/%{name}/%{version}/tmac/pdf.tmac
%exclude %{_bindir}/afmtodit
%exclude %{_bindir}/chem
%exclude %{_bindir}/groffer
%exclude %{_bindir}/grog
%exclude %{_bindir}/gropdf
%exclude %{_bindir}/mmroff
%exclude %{_bindir}/pdfmom
%exclude %{_bindir}/roff2dvi
%exclude %{_bindir}/roff2html
%exclude %{_bindir}/roff2pdf
%exclude %{_bindir}/roff2ps
%exclude %{_bindir}/roff2text
%exclude %{_bindir}/roff2x
...
- import source package RHEL7/groff-1.22.2-8.el7

* Wed Mar 5 2014 Tom Kirchner <tjk@amazon.com>
- groff-base has files conflicting with older groff

* Wed Jan 29 2014 Cristian Gafton <gafton@amazon.com>
- clean up file manifest when not compiling X11 binaries
...
- import source package RHEL7/groff-1.22.2-6.el7
...
- import source package RHEL6/groff-1.18.1.4-21.el6
...
* Thu Jul 15 2010 Cristian Gafton <gafton@amazon.com>
- use X11 cnditional

* Fri Jul 9 2010 Cristian Gafton <gafton@amazon.com>
- import source package RHEL6/groff-1.18.1.4-19.el6
- import source package RHEL6/groff-1.18.1.4-18.1.el6

* Fri May 7 2010 Cristian Gafton <gafton@amazon.com>
- import source package RHEL5/groff-1.18.1.1-11.1
- added submodule prep for package groff

...
or APIs, you'll need to install GraphicsMagick-c++-devel, GraphicsMagick-devel and
GraphicsMagick.
...
cp %{SOURCE2000} %{buildroot}%{_includedir}/GraphicsMagick/magick/magick_types.h
%endif
...
%{_mandir}/man1/GraphicsMagick-config.1.gz
%{_mandir}/man1/GraphicsMagickWand-config.1.gz
...
%{_mandir}/man3/Graphics::Magick.3pm.gz
...
%{perl_vendorarch}/auto/Graphics/Magick/Magick.so

...
* Thu Mar 19 2020 Builder <builder@amazon.com>
- builder/68324ab906c0e45891a905c7ccd84e0e30084127 last changes:
  + [68324ab] [2020-03-19] Rebase to v4.14.173 (linuxci@amazon.com)

- linux/6ac12796ff220934ee4c5c2313be832143552d81 last changes:
  + [6ac1279] [2020-03-08] lustre: update to AmazonFSxLustreClient v2.10.8-1 (astroh@amazon.com)
  + [10dee01] [2020-01-29] random: introduce RANDOM_WAIT_JITTER config option (fllinden@amazon.com)
  + [5d7f441] [2019-09-28] random: try to actively add entropy rather than passively wait for it (torvalds@linux-foundation.org)
  + [c4e961e3] [2020-02-26] ena: update to 2.2.3 (fllinden@amazon.com)
  + [cac3832] [2019-06-26] perf: arm_spe: Enable ACPI/Platform automatic module loading (jeremy.linton@arm.com)
  + [ef1aec5] [2019-06-26] arm_pmu: acpi: spe: Add initial MADT/SPE probing (jeremy.linton@arm.com)
  + [c1eb1b9] [2019-06-26] ACPI/PPTT: Add function to return ACPI 6.3 Identical tokens (jeremy.linton@arm.com)
  + [89fc870] [2019-06-26] ACPI/PPTT: Modify node flag detection to find last IDENTICAL (jeremy.linton@arm.com)
  + [0dce87b] [2020-01-29] ACPICA: ACPI 6.3: PPTT add additional fields in Processor Structure Flags (erik.schmauss@intel.com)
  + [adfd55a] [2020-01-28] ACPICA: ACPI 6.3: MADT: add support for statistical profiling in GICC (erik.schmauss@intel.com)
  + [c2c2ca3] [2018-08-10] perf arm spe: Fix uninitialized record error variable (kim.phillips@arm.com)
  + [20c0aea] [2018-01-14] perf tools: Add ARM Statistical Profiling Extensions (SPE) support (kim.phillips@arm.com)
  + [ff14784] [2016-09-22] drivers/perf: Add support for ARMv8.2 Statistical Profiling Extension (will.deacon@arm.com)
  + [f54fb81] [2016-09-22] dt-bindings: Document devicetree binding for ARM SPE (will.deacon@arm.com)
  + [874014b] [2017-07-07] arm64: head: Init PMSCR_EL2.{PA,PCT} when entered at EL2 without VHE (will.deacon@arm.com)
  + [b40b4c3] [2017-09-20] arm64: sysreg: Move SPE registers and PSB into common header files (will.deacon@arm.com)
  + [95a9149] [2016-09-23] perf/core: Add PERF_AUX_FLAG_COLLISION to report colliding samples (will.deacon@arm.com)
  + [c5b248da] [2016-08-16] perf/core: Export AUX buffer helpers to modules (will.deacon@arm.com)
  + [bc64ff8] [2016-07-25] genirq: export irq_get_percpu_devid_partition to modules (will.deacon@arm.com)
  + [9736898] [2018-03-29] Don't log confusing message on reconnect by default (stfrench@microsoft.com)
  + [488748f] [2018-03-21] Don't log expected error on DFS referral request (smfrench@gmail.com)
  + [e2c4111] [2017-11-21] CIFS: don't log STATUS_NOT_FOUND errors for DFS (aaptel@suse.com)
  + [ca15ffe] [2018-07-05] cifs: Fix slab-out-of-bounds in send_set_info() on SMB2 ACE setting (sbrivio@redhat.com)
  + [7defede] [2019-12-31] lib/list-test: add a test for the 'list' doubly linked list (davidgow@google.com)
  + [0b422e2] [2019-09-08] Documentation: kunit: Fix verification command (sj38.park@gmail.com)
  + [9edcfd9] [2019-09-23] Documentation: kunit: add documentation for KUnit (brendanhiggins@google.com)
  + [de6f164] [2019-09-07] kunit: Fix '--build_dir' option (sj38.park@gmail.com)
  + [3e13a4e] [2019-09-23] kunit: defconfig: add defconfigs for building KUnit tests (brendanhiggins@google.com)
  + [2070bb6] [2019-09-23] kunit: tool: add Python wrappers for running KUnit tests (felixguoxiuping@gmail.com)
  + [98811d8] [2019-09-23] kunit: fix failure to build without printk (brendanhiggins@google.com)
  + [3149367] [2019-09-23] kunit: test: add tests for KUnit managed resources (akndr41@gmail.com)
  + [f0cf842] [2019-09-23] kunit: test: add the concept of assertions (brendanhiggins@google.com)
  + [e2454eb] [2019-09-23] kunit: test: add tests for kunit test abort (brendanhiggins@google.com)
  + [710d426] [2019-09-23] kunit: test: add support for test abort (brendanhiggins@google.com)
  + [48b966d] [2019-09-23] kunit: test: add initial tests (brendanhiggins@google.com)
  + [f84a847] [2019-12-31] lib: enable building KUnit in lib/ (brendanhiggins@google.com)
  + [f8c851d] [2019-09-23] kunit: test: add the concept of expectations (brendanhiggins@google.com)
  + [1a4dbbc] [2019-09-23] kunit: test: add assertion printing library (brendanhiggins@google.com)
  + [ab823f5] [2019-09-23] kunit: test: add string_stream a std::stream like string builder (brendanhiggins@google.com)
  + [03efa4a] [2019-09-23] kunit: test: add test resource management API (brendanhiggins@google.com)
  + [7232d44] [2019-09-23] kunit: test: add KUnit test runner core (brendanhiggins@google.com)
  + [c14dd62] [2020-02-03] Revert "update ENA linux driver to version 2.2.1" (anchalag@amazon.com)
  + [f70bc62] [2020-01-20] update ENA linux driver to version 2.2.1 (anchalag@amazon.com)
  + [d5f80f4] [2019-12-18] Add support for setting owner info, dos attributes, and create time (bprotopopov@hotmail.com)
  + [e4e8d4e] [2018-08-28] SMB3: Backup intent flag missing from compounded ops (stfrench@microsoft.com)
  + [5082425] [2019-12-19] drivers/amazon: efa: update to 1.5.0 (luqia@amazon.com)
  + [8522eb3] [2019-12-16] Revert "Fix the locking in dcache_readdir() and friends". (fllinden@amazon.com)
  + [808f13f] [2019-12-04] lustre: hold lock while walking changelog dev list (astroh@amazon.com)
  + [22a5bf4] [2019-11-15] arm64: fix merge error in errata changes (fllinden@amazon.com)
  + [c460122] [2019-11-12] nvme-pci: use atomic bitops to mark a queue enabled (hch@lst.de)
  + [c97a5e3] [2019-11-11] nvme-pci: Don't disable on timeout in reset state (keith.busch@intel.com)
  + [120d20d] [2019-11-11] nvme-pci: Unblock reset_work on IO failure (keith.busch@intel.com)
  + [a94719f] [2019-11-11] nvme-pci: shutdown on timeout during deletion (keith.busch@intel.com)
  + [861963a] [2018-02-08] nvme-pci: Fix timeouts in connecting state (keith.busch@intel.com)
  + [a892a07] [2019-11-11] nvme: rename NVME_CTRL_RECONNECTING state to NVME_CTRL_CONNECTING (maxg@mellanox.com)
  + [5eaf68f] [2017-10-25] nvme: allow controller RESETTING to RECONNECTING transition (jsmart2021@gmail.com)
  + [4aa35b5] [2019-11-11] nvme-pci: introduce RECONNECTING state to mark initializing procedure (jianchao.w.wang@oracle.com)
  + [438dcb1] [2019-11-11] Revert "nvme/pci: Better support for disabling controller" (sblbir@amazon.com)
  + [5335708] [2019-11-04] update ena driver to version 2.1.3 (alakeshh@amazon.com)
  + [cb10f19] [2018-06-22] arm64: Avoid flush_icache_range() in alternatives patching code (will.deacon@arm.com)
  + [cebf25b] [2018-09-27] arm64: pull in upstream erratum workarounds (fllinden@amazon.com)
  + [904742881] [2018-03-13] arm64: kconfig: Ensure spinlock fastpaths are inlined if !PREEMPT (will.deacon@arm.com)
  + [dea17ec] [2018-03-13] arm64: locking: Replace ticket lock implementation with qspinlock (will.deacon@arm.com)
  + [38bd92a] [2018-01-31] arm64: barrier: Implement smp_cond_load_relaxed (will.deacon@arm.com)
  + [640a4b4] [2018-04-26] MAINTAINERS: Add myself as a co-maintainer for the locking subsystem (will.deacon@arm.com)
  + [c2df3c7] [2018-04-26] locking/qspinlock: Use try_cmpxchg() instead of cmpxchg() when locking (will.deacon@arm.com)
  + [45a0a5f] [2018-04-26] locking/qspinlock: Elide back-to-back RELEASE operations with smp_wmb() (will.deacon@arm.com)
  + [1db112d] [2018-04-26] locking/qspinlock: Use smp_store_release() in queued_spin_unlock() (will.deacon@arm.com)
  + [1f82148] [2018-04-26] locking/qspinlock: Use smp_cond_load_relaxed() to wait for next node (will.deacon@arm.com)
  + [b7c40ba] [2018-04-26] locking/mcs: Use smp_cond_load_acquire() in MCS spin loop (jason.low2@hp.com)
  + [50a7f62] [2018-04-26] locking/qspinlock: Use atomic_cond_read_acquire() (will.deacon@arm.com)
  + [4be74b8] [2018-04-26] locking/barriers: Introduce smp_cond_load_relaxed() and atomic_cond_read_relaxed() (will.deacon@arm.com)
  + [04906af] [2017-10-12] locking/atomic: Add atomic_cond_read_acquire() (will.deacon@arm.com)
  + [33bf85d] [2019-08-29] iommu: use config option to specify if iommu mode should be strict (fllinden@amazon.com)
  + [f287182] [2018-09-20] iommu/arm-smmu: Support non-strict mode (robin.murphy@arm.com)
  + [81c94e7b] [2018-09-20] iommu/io-pgtable-arm-v7s: Add support for non-strict mode (robin.murphy@arm.com)
  + [7417b4c] [2018-09-20] iommu/arm-smmu-v3: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [ad50813] [2018-09-20] iommu/io-pgtable-arm: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [ac3dfa5] [2018-09-20] iommu: Add "iommu.strict" command line option (thunder.leizhen@huawei.com)
  + [5fb48c4] [2018-09-20] iommu/dma: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [4c96b51] [2018-09-20] iommu/arm-smmu-v3: Implement flush_iotlb_all hook (thunder.leizhen@huawei.com)
  + [c99a956] [2017-09-28] iommu/io-pgtable-arm-v7s: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [97bc2d6] [2017-09-28] iommu/io-pgtable-arm: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [11cd919] [2019-03-12] irqchip/gic-v3-its: Fix comparison logic in lpi_range_cmp (linux@rasmusvillemoes.dk)
  + [6ea900c] [2019-01-29] irqchip/gic-v3-its: Gracefully fail on LPI exhaustion (marc.zyngier@arm.com)
  + [2e04d22] [2018-08-28] irqchip/gic-v3-its: Cap lpi_id_bits to reduce memory footprint (jia.he@hxt-semitech.com)
  + [55a0160] [2018-05-31] irqchip/gic-v3-its: Reduce minimum LPI allocation to 1 for PCI devices (marc.zyngier@arm.com)
  + [90b655a] [2018-05-31] irqchip/gic-v3-its: Honor hypervisor enforced LPI range (marc.zyngier@arm.com)
  + [e390b89] [2018-05-30] irqchip/gic-v3: Expose GICD_TYPER in the rdist structure (marc.zyngier@arm.com)
  + [79ada4d] [2018-05-27] irqchip/gic-v3-its: Drop chunk allocation compatibility (marc.zyngier@arm.com)
  + [bcec01f] [2018-05-27] irqchip/gic-v3-its: Move minimum LPI requirements to individual busses (marc.zyngier@arm.com)
  + [4914875] [2018-05-27] irqchip/gic-v3-its: Use full range of LPIs (marc.zyngier@arm.com)
  + [cf33a3c] [2018-05-27] irqchip/gic-v3-its: Refactor LPI allocator (marc.zyngier@arm.com)
  + [ca4d516] [2018-06-22] irqchip/gic-v3-its: Only emit VSYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [5faa8f2] [2018-06-22] irqchip/gic-v3-its: Only emit SYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [69a2c6e] [2017-07-28] irqchip/gic-v3-its: Pass its_node pointer to each command builder (marc.zyngier@arm.com)
  + [4473587] [2018-05-17] nvme-pci: move ->cq_vector == -1 check outside of ->q_lock (axboe@kernel.dk)
  + [5889e5b] [2019-09-13] nvme/host/pci: Fix a race in controller removal (sblbir@amzn.com)
  + [dfc859d] [2019-09-13] nvme/host/core: Allow overriding of wait_ready timeout (sblbir@amzn.com)
  + [3a59c45] [2019-09-10] nvme/pci: Better support for disabling controller (sblbir@amzn.com)
  + [327499e] [2017-11-02] nvme: move the dying queue check from cancel to completion (hch@lst.de)
  + [14fb057] [2019-08-28] blk-mq: fix hang caused by freeze/unfreeze sequence (bob.liu@oracle.com)
  + [cbb122e] [2019-08-16] nvme: change namespaces_mutext to namespaces_rwsem (jianchao.w.wang@oracle.com)
  + [3d78faa] [2018-09-26] block: Allow unfreezing of a queue while requests are in progress (bvanassche@acm.org)
  + [cc3eecf] [2019-08-16] percpu-refcount: Introduce percpu_ref_resurrect() (bvanassche@acm.org)
  + [b033e58] [2019-09-05] Add Amazon EFA driver version 1.4 (alakeshh@amazon.com)
  + [b910989] [2019-04-02] block: don't show io_timeout if driver has no timeout handler (zhangweiping@didiglobal.com)
  + [09f3c46] [2018-11-29] block: add io timeout to sysfs (zhangweiping@didiglobal.com)
  + [16aba8b] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [0033b9b] [2019-01-09] livepatch: Change unsigned long old_addr -> void *old_func in struct klp_func (pmladek@suse.com)
  + [d93fb71] [2018-11-07] livepatch: Replace synchronize_sched() with synchronize_rcu() (paulmck@linux.ibm.com)
  + [1e935d7] [2018-07-12] livepatch: Remove reliable stacktrace check in klp_try_switch_task() (kamalesh@linux.vnet.ibm.com)
  + [4ac55bf] [2018-04-16] livepatch: Allow to call a custom callback when freeing shadow variables (pmladek@suse.com)
  + [26a2eff] [2018-04-16] livepatch: Initialize shadow variables safely by a custom callback (pmladek@suse.com)
  + [db40786] [2017-12-21] livepatch: add locking to force and signal functions (mbenes@suse.cz)
  + [4cb3783] [2018-01-10] livepatch: Remove immediate feature (mbenes@suse.cz)
  + [9ed63ec] [2017-11-22] livepatch: force transition to finish (mbenes@suse.cz)
  + [1f119f98] [2017-11-15] livepatch: send a fake signal to all blocking tasks (mbenes@suse.cz)
  + [3173c87] [2017-10-20] livepatch: __klp_disable_patch() should never be called for disabled patches (pmladek@suse.com)
  + [53fdc8e] [2017-10-20] livepatch: Correctly call klp_post_unpatch_callback() in error paths (pmladek@suse.com)
  + [61d7afd] [2017-10-13] livepatch: add transition notices (joe.lawrence@redhat.com)
  + [3bf91d2] [2017-10-13] livepatch: move transition "complete" notice into klp_complete_transition() (joe.lawrence@redhat.com)
  + [e5f8652] [2017-10-13] livepatch: add (un)patch callbacks (joe.lawrence@redhat.com)
  + [283fe4b] [2017-09-14] livepatch: __klp_shadow_get_or_alloc() is local to shadow.c (jkosina@suse.cz)
  + [81b4d79] [2017-08-31] livepatch: introduce shadow variable API (joe.lawrence@redhat.com)
  + [d7fff33] [2019-08-15] Partially revert cc946adcb9e983ad9fe56ebe35f1292e111ff10e (sblbir@amzn.com)
  + [44c87ec] [2019-07-11] PCI: Add ACS quirk for Amazon Annapurna Labs root ports (alisaidi@amazon.com)
  + [03065bc] [2019-07-11] PCI: Add Amazon's Annapurna Labs vendor ID (jonnyc@amazon.com)
  + [67ccc69] [2019-06-24] linux/ena: update ENA linux driver to version 2.1.1 (fllinden@amazon.com)
  + [c0baf12] [2019-07-02] microvm: enable debug in case of tcp out of memory (alakeshh@amazon.com)
  + [76464bb] [2019-07-03] Fix microvm config dependency in Kconfig (alakeshh@amazon.com)
  + [5122979] [2019-02-12] NFS: Remove redundant semicolon (zhangliguang@linux.alibaba.com)
  + [7834dc1] [2019-05-31] arm64: acpi/pci: invoke _DSM whether to preserve firmware PCI setup (fllinden@amazon.com)
  + [30798dc] [2019-03-28] PCI: al: Add Amazon Annapurna Labs PCIe host controller driver (jonnyc@amazon.com)
  + [22a298a] [2019-04-24] irqchip/gic-v2m: invoke from gic-v3 initialization and add acpi quirk flow (zeev@amazon.com)
  + [26c0f47] [2019-04-03] lustre: fix ACL handling (fllinden@amazon.com)
  + [2c40318] [2018-05-18] x86/stacktrace: Enable HAVE_RELIABLE_STACKTRACE for the ORC unwinder (jslaby@suse.cz)
  + [a6877a2] [2018-05-18] x86/unwind/orc: Detect the end of the stack (jpoimboe@redhat.com)
  + [2ad4521] [2018-05-18] x86/stacktrace: Do not fail for ORC with regs on stack (jslaby@suse.cz)
  + [1fb5b39] [2018-05-18] x86/stacktrace: Clarify the reliable success paths (jslaby@suse.cz)
  + [793709e] [2018-05-18] x86/stacktrace: Remove STACKTRACE_DUMP_ONCE (jslaby@suse.cz)
  + [43a91d8] [2018-05-18] x86/stacktrace: Do not unwind after user regs (jslaby@suse.cz)
  + [4292675] [2019-03-12] Add new config CONFIG_MICROVM to enable microvm optimized kernel (alakeshh@amazon.com)
  + [0c8f779] [2019-02-19] tcp: Namespace-ify sysctl_tcp_rmem and sysctl_tcp_wmem (edumazet@google.com)
  + [1f874f3] [2017-11-07] net: allow per netns sysctl_rmem and sysctl_wmem for protos (edumazet@google.com)
  + [2ac048b] [2019-03-01] Config glue for lustre client. (fllinden@amazon.com)
  + [87977f6] [2019-03-01] Import lustre client 2.10.5 (fllinden@amazon.com)
  + [4a3ee75] [2018-06-05] iomap: fsync swap files before iterating mappings (darrick.wong@oracle.com)
  + [ffa2174] [2018-06-01] iomap: inline data should be an iomap type, not a flag (hch@lst.de)
  + [9437ef6] [2018-05-16] iomap: don't allow holes in swapfiles (osandov@fb.com)
  + [46805a3] [2018-05-16] iomap: provide more useful errors for invalid swap files (osandov@fb.com)
  + [494615d] [2018-05-10] iomap: add a swapfile activation function (darrick.wong@oracle.com)
  + [0532eac] [2019-01-30] xfs, iomap: define and use the IOMAP_F_DIRTY flag in xfs (fllinden@amazon.com)
  + [4d1087d] [2018-08-01] xfs: only validate summary counts on primary superblock (darrick.wong@oracle.com)
  + [f8279d5] [2018-07-26] libxfs: add more bounds checking to sb sanity checks (billodo@redhat.com)
  + [7877bb8] [2018-07-29] xfs: refactor superblock verifiers (darrick.wong@oracle.com)
  + [43efbeb7] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [a8ade08e] [2018-10-04] ACPI/PPTT: Handle architecturally unknown cache types (jhugo@codeaurora.org)
  + [d769753] [2018-06-05] ACPI / PPTT: fix build when CONFIG_ACPI_PPTT is not enabled (sudeep.holla@arm.com)
  + [060f795] [2018-06-29] ACPI / PPTT: use ACPI ID whenever ACPI_PPTT_ACPI_PROCESSOR_ID_VALID is set (Sudeep.Holla@arm.com)
  + [2f82d89] [2018-05-11] arm64: topology: divorce MC scheduling domain from core_siblings (jeremy.linton@arm.com)
  + [deb479c] [2018-05-11] ACPI: Add PPTT to injectable table list (jeremy.linton@arm.com)
  + [236d01f] [2018-05-11] arm64: topology: enable ACPI/PPTT based CPU topology (jeremy.linton@arm.com)
  + [5b98a4b] [2018-05-11] arm64: topology: rename cluster_id (jeremy.linton@arm.com)
  + [f389236] [2018-05-11] arm64: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [a7353fc] [2018-05-11] drivers: base cacheinfo: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [422ca16] [2018-05-11] ACPI: Enable PPTT support on ARM64 (jeremy.linton@arm.com)
  + [6bfc34f] [2018-05-11] ACPI/PPTT: Add Processor Properties Topology Table parsing (jeremy.linton@arm.com)
  + [b206396] [2018-05-11] arm64/acpi: Create arch specific cpu to acpi id helper (jeremy.linton@arm.com)
  + [aa9b18a] [2018-05-11] cacheinfo: rename of_node to fw_token (jeremy.linton@arm.com)
  + [286480b] [2018-05-11] drivers: base: cacheinfo: setup DT cache properties early (jeremy.linton@arm.com)
  + [d955055] [2018-05-11] drivers: base: cacheinfo: move cache_setup_of_node() (jeremy.linton@arm.com)
  + [579e5c0] [2017-11-17] ACPICA: ACPI 6.2: Additional PPTT flags (jeremy.linton@arm.com)
  + [9288ce5] [2018-07-23] arm64: acpi: fix alignment fault in accessing ACPI (takahiro.akashi@linaro.org)
  + [00421f7] [2018-07-02] arm64: kexec: always reset to EL2 if present (mark.rutland@arm.com)
  + [f66b215] [2018-03-08] efi/arm64: Check whether x18 is preserved by runtime services calls (ard.biesheuvel@linaro.org)
  + [964dfb6] [2018-10-11] arm64: Fix /proc/iomem for reserved but not memory regions (will.deacon@arm.com)
  + [cbb5259] [2018-07-23] arm64: export memblock_reserve()d regions via /proc/iomem (james.morse@arm.com)
  + [ad43b63] [2018-11-10] net: ena: Import the ENA v2 driver (2.0.2g) (alakeshh@amazon.com)
  + [a0cba89] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [57b8fe0] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [2e0cb0c3] [2018-10-29] ACPICA: Enable sleep button on ACPI legacy wake (anchalag@amazon.com)
  + [00cfaf0] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [1f1ad1a] [2017-11-30] vmxnet3: increase default rx ring sizes (skhare@vmware.com)
  + [bd13cc1] [2018-04-27] x86/CPU/AMD: Derive CPU topology from CPUID function 0xB when available (suravee.suthikulpanit@amd.com)
  + [36a231d] [2017-09-07] sched/topology: Introduce NUMA identity node sched domain (suravee.suthikulpanit@amd.com)
  + [53f4565] [2018-06-13] x86/CPU/AMD: Fix LLC ID bit-shift calculation (suravee.suthikulpanit@amd.com)
  + [5aafbb3] [2018-04-27] x86/CPU/AMD: Calculate last level cache ID from number of sharing threads (suravee.suthikulpanit@amd.com)
  + [89b0d8d] [2018-04-27] x86/CPU: Rename intel_cacheinfo.c to cacheinfo.c (bp@suse.de)
  + [c2e5e1c] [2018-05-17] x86/MCE/AMD: Read MCx_MISC block addresses on any CPU (bp@suse.de)
  + [11a729c] [2018-08-15] blk-wbt: Avoid lock contention and thundering herd issue in wbt_wait (anchalag@amazon.com)
  + [1ba989e0] [2018-01-12] blk-mq: simplify queue mapping & schedule with each possisble CPU (hch@lst.de)
  + [325aa7a] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [7e6d142] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [473ce3a] [2018-03-24] KVM: X86: Fix setup the virt_spin_lock_key before static key get initialized (wanpengli@tencent.com)
  + [6b30e54] [2017-10-28] x86/paravirt: Set up the virt_spin_lock_key after static keys get initialized (douly.fnst@cn.fujitsu.com)
  + [bf45663] [2018-02-13] KVM: X86: Choose qspinlock when dedicated physical CPUs are available (wanpengli@tencent.com)
  + [9e20790] [2018-02-13] KVM: Introduce paravirtualization hints and KVM_HINTS_DEDICATED (wanpengli@tencent.com)
  + [1735417] [2017-09-06] locking/paravirt: Use new static key for controlling call of virt_spin_lock() (jgross@suse.com)
  + [54faee2] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [9eea666] [2018-01-18] ACPI: SPCR: Make SPCR available to x86 (prarit@redhat.com)
  + [608a603] [2016-04-26] xen-blkfront: add 'persistent_grants' parameter (aliguori@amazon.com)
  + [4466cb1] [2017-03-10] xen-blkfront: resurrect request-based mode (kamatam@amazon.com)
  + [6ad0b38] [2017-11-02] Not-for-upstream: PM / hibernate: Speed up hibernation by batching requests (cyberax@amazon.com)
  + [599a2db] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [d302e06] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [a41b73e] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [14dd90f] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [daf6604] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [eb8bb6d] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [9cef555] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [bc1a5b7] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [95b1c8f] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [aea9078] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [7fbe8df] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [82e32e2] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [be795a3] [2018-02-27] Importing Amazon ENA driver 1.5.0 into amazon-4.14.y/master. (vallish@amazon.com)
  + [5f677d0] [2018-02-12] drivers/amazon: introduce AMAZON_ENA_ETHERNET (vallish@amazon.com)
  + [11265bdf] [2018-02-12] drivers/amazon: add network device drivers support (vallish@amazon.com)
  + [a110862] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [93877c6] [2017-10-27] not-for-upstream: testmgr config changes to enable FIPS boot (alakeshh@amazon.com)
  + [aad98444] [2017-09-19] nvme: update timeout module parameter type (vallish@amazon.com)
  + [f3088a0e] [2015-12-08] force perf to use /usr/bin/python instead of /usr/bin/python2 (kamatam@amazon.com)
  + [28de979] [2013-02-13] bump default tcp_wmem from 16KB to 20KB (gafton@amazon.com)
  + [bb48cb3] [2016-01-26] bump the default TTL to 255 (kamatam@amazon.com)
  + [acb4fb86] [2012-02-10] scsi: sd_revalidate_disk prevent NULL ptr deref (kernel-team@fedoraproject.org)
  + [d2d5c80] [2008-10-06] kbuild: AFTER_LINK (roland@redhat.com)

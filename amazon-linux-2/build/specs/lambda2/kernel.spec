...
Source0: linux-4.14.200.tar
Source1: linux-4.14.200-patches.tar
...
Patch0320: 0320-arm64-paravirt-Initialize-steal-time-when-cpu-is-onl.patch
Patch0321: 0321-efa-update-to-1.10.1.patch
...
ApplyPatch 0320-arm64-paravirt-Initialize-steal-time-when-cpu-is-onl.patch
ApplyPatch 0321-efa-update-to-1.10.1.patch
...
+* Thu Oct 15 2020 Builder <builder@amazon.com>
- builder/81a9a8bfa9b6020a405e4f11dcfa90dc298eb718 last changes:
  + [81a9a8b] [2020-10-14] test amazon-4.14.200-ke-efa (kkexu@amazon.com)

- linux/ff2fe7d6f5b5a3909dc1e26b20e49ca048d7f599 last changes:
  + [ff2fe7d] [2020-10-15] efa: update to 1.10.1 (kkexu@amazon.com)
  + [1b5dd11] [2020-09-16] arm64: paravirt: Initialize steal time when cpu is online (drjones@redhat.com)
  + [209378d] [2020-08-24] netfilter: ctnetlink: add a range check for l3/l4 protonum (willmcvicker@google.com)
  + [3b8e0d8] [2020-09-15] nfs: Fix security label length not being reset (jeffrey.mitchell@starlab.io)
  + [9eb0bae] [2020-01-22] nfs: optimise readdir cache page invalidation (dai.ngo@oracle.com)
  + [de83774] [2020-09-18] arm64: Enable PCI write-combine resources under sysfs (csbisa@amazon.com)
  + [c9764d2] [2020-04-17] MAINTAINERS: Add entry for the Nitro Enclaves driver (andraprs@amazon.com)
  + [972ecca] [2020-05-18] nitro_enclaves: Add overview documentation (andraprs@amazon.com)
  + [3456e8a] [2020-05-18] nitro_enclaves: Add sample for ioctl interface usage (andraprs@amazon.com)
  + [8201131] [2020-02-05] nitro_enclaves: Add Makefile for the Nitro Enclaves driver (andraprs@amazon.com)
  + [3a34684] [2020-09-17] enclaves: Define PCI_VENDOR_ID_AMAZON (samjonas@amazon.com)
  + [30837fb] [2020-02-05] nitro_enclaves: Add Kconfig for the Nitro Enclaves driver (andraprs@amazon.com)
  + [d12480e8] [2020-03-09] nitro_enclaves: Add logic for terminating an enclave (andraprs@amazon.com)
  + [3b3016c] [2020-03-09] nitro_enclaves: Add logic for starting an enclave (andraprs@amazon.com)
  + [4bac0ae] [2020-03-09] nitro_enclaves: Add logic for setting an enclave memory region (andraprs@amazon.com)
  + [734565d9] [2020-05-21] nitro_enclaves: Add logic for getting the enclave image load info (andraprs@amazon.com)
  + [7ecc9bb] [2020-03-09] nitro_enclaves: Add logic for setting an enclave vCPU (andraprs@amazon.com)
  + [39208dc] [2020-03-09] nitro_enclaves: Add logic for creating an enclave VM (andraprs@amazon.com)
  + [b5760df] [2020-03-09] nitro_enclaves: Init misc device providing the ioctl interface (andraprs@amazon.com)
  + [468c905] [2020-03-09] nitro_enclaves: Handle out-of-band PCI device events (andraprs@amazon.com)
  + [93dbd91] [2020-03-09] nitro_enclaves: Handle PCI device command requests (andraprs@amazon.com)
  + [e8a431c] [2020-03-09] nitro_enclaves: Init PCI device driver (andraprs@amazon.com)
  + [a925ec9] [2020-03-10] nitro_enclaves: Define enclave info for internal bookkeeping (andraprs@amazon.com)
  + [7453356f] [2020-02-05] nitro_enclaves: Define the PCI device interface (andraprs@amazon.com)
  + [842687c] [2020-02-05] nitro_enclaves: Add ioctl interface definition (andraprs@amazon.com)
  + [e820bec] [2020-09-17] Partial backport of "mm: introduce page_size()" (samjonas@amazon.com)
  + [460aac0] [2017-07-02] define __poll_t, annotate constants (viro@zeniv.linux.org.uk)
  + [ca9627e] [2020-03-23] cpu/hotplug: Add new {add,remove}_cpu() functions (qais.yousef@arm.com)
  + [91c2ba8] [2020-08-30] net/packet: fix overflow in tpacket_rcv (orcohen@paloaltonetworks.com)
  + [fba0f74] [2020-09-01] Remove unused variables in the nvme disk resize patches (yishache@amazon.com)
  + [3119b8c] [2020-08-27] drivers/amazon: efa: update to 1.9.0 (yishache@amazon.com)
  + [7271a36] [2018-01-24] CIFS: use tcon_ipc instead of use_ipc parameter of SMB2_ioctl (aaptel@suse.com)
  + [bec6923] [2018-01-24] CIFS: make IPC a regular tcon (aaptel@suse.com)
  + [f1f6966] [2020-02-25] drivers/scsi/sd.c: Convert to use set_capacity_revalidate_and_notify (sblbir@amazon.com)
  + [54e8294] [2020-02-25] drivers/nvme/host/core.c: Convert to use set_capacity_revalidate_and_notify (sblbir@amazon.com)
  + [a576677] [2020-02-25] drivers/block/xen-blkfront.c: Convert to use set_capacity_revalidate_and_notify (sblbir@amazon.com)
  + [473602f] [2020-02-25] drivers/block/virtio_blk.c: Convert to use set_capacity_revalidate_and_notify (sblbir@amazon.com)
  + [87a14d7] [2020-02-25] block/genhd: Notify udev about capacity change (sblbir@amazon.com)
  + [a4b1b83] [2019-12-17] UBUNTU SAUCE [aws]: mm: swap: improve swap readahead heuristic (andrea.righi@canonical.com)
  + [91f7aa8] [2019-05-10] UBUNTU SAUCE [aws]: mm: aggressive swapoff (andrea.righi@canonical.com)
  + [5d0d7e7] [2019-05-10] sched/wait: Introduce wait_var_event() (peterz@infradead.org)
  + [c3d8a44] [2019-05-10] mm: swapoff: shmem_unuse() stop eviction without igrab() (hughd@google.com)
  + [955634b] [2019-05-10] mm: rid swapoff of quadratic complexity (vpillai@digitalocean.com)
  + [576bd0e] [2019-08-15] xfs: fall back to native ioctls for unhandled compat ones (hch@lst.de)
  + [8883cd4] [2018-06-05] xfs: fix string handling in label get/set functions (arnd@arndb.de)
  + [0d7a4f0] [2018-05-15] xfs: implement online get/set fs label (sandeen@sandeen.net)
  + [3470f65] [2020-07-08] xfs: add prerequisite for online labeling (astroh@amazon.com)
  + [636cd1b] [2018-05-13] xfs: one-shot cached buffers (dchinner@redhat.com)
  + [d32be63] [2018-05-15] fs: copy BTRFS_IOC_[SG]ET_FSLABEL to vfs (sandeen@redhat.com)
  + [d2e1d30] [2020-07-13] ena: Update to 2.2.10 (surajjs@amazon.com)
  + [59269a1] [2019-12-09] Makefile: Add AMZN specific variables (luqia@amazon.com)
  + [656eced] [2019-10-21] arm64: Retrieve stolen time as paravirtualized guest (steven.price@arm.com)
  + [c3ffad0] [2019-10-21] arm/arm64: Make use of the SMCCC 1.1 wrapper (steven.price@arm.com)
  + [88fc083] [2019-10-21] arm/arm64: Provide a wrapper for SMCCC 1.1 calls (steven.price@arm.com)
  + [8fd8c17] [2019-08-09] arm/arm64: smccc/psci: add arm_smccc_1_1_get_conduit() (mark.rutland@arm.com)
  + [7739887] [2019-10-21] KVM: arm64: Provide VCPU attributes for stolen time (steven.price@arm.com)
  + [4acc0f5] [2019-10-21] KVM: Allow kvm_device_ops to be const (steven.price@arm.com)
  + [5269414] [2019-10-21] KVM: arm64: Support stolen time reporting via shared structure (steven.price@arm.com)
  + [6300096] [2019-10-21] KVM: Implement kvm_put_guest() (steven.price@arm.com)
  + [ecc7bd3] [2019-10-21] KVM: arm64: Implement PV_TIME_FEATURES call (steven.price@arm.com)
  + [86fea07] [2019-10-21] KVM: arm/arm64: Factor out hypercall handling from PSCI code (christoffer.dall@arm.com)
  + [003a61c] [2020-02-13] printk: Correctly set CON_CONSDEV even when preferred console was not registered (benh@kernel.crashing.org)
  + [738d159] [2020-02-13] printk: Fix preferred console selection with multiple matches (benh@kernel.crashing.org)
  + [cd2b0ea] [2020-02-13] printk: Move console matching logic into a separate function (benh@kernel.crashing.org)
  + [2586724] [2020-06-18] Update lustrefsx to v2.10.8-5 (astroh@amazon.com)
  + [08f1f73] [2020-05-27] lustre: restore mgc binding for sptlrpc (astroh@amazon.com)
  + [5458712] [2019-04-11] NFSv4.1 fix incorrect return value in copy_file_range (kolga@netapp.com)
  + [2d15b43] [2020-05-27] Fix a build issue caused by 45b2013293a2a (sblbir@amazon.com)
  + [1378ad9] [2020-05-26] Upgrade to ena 2.2.8 (sblbir@amazon.com)
  + [12cae67] [2020-04-13] xen-blkfront: Delay flush till queue lock dropped (samjonas@amazon.com)
  + [e57085b] [2019-04-23] iommu/arm-smmu-v3: Don't disable SMMU in kdump kernel (will.deacon@arm.com)
  + [8cd8558] [2018-07-25] iommu/arm-smmu-v3: Abort all transactions if SMMU is enabled in kdump kernel (will.deacon@arm.com)
  + [1daa027] [2018-07-12] iommu/arm-smmu-v3: Prevent any devices access to memory without registration (thunder.leizhen@huawei.com)
  + [b147ad6] [2018-07-27] irqchip/gic-v3-its: Allow use of LPI tables in reserved memory (marc.zyngier@arm.com)
  + [7cd3328] [2018-07-27] irqchip/gic-v3-its: Register LPI tables with EFI config table (marc.zyngier@arm.com)
  + [5928fba] [2018-07-27] irqchip/gic-v3-its: Check that all RDs have the same property table (marc.zyngier@arm.com)
  + [e09aea6] [2018-06-26] irqchip/gic-v3-its: Use pre-programmed redistributor tables with kdump kernels (marc.zyngier@arm.com)
  + [92398cc] [2018-07-27] irqchip/gic-v3-its: Allow use of pre-programmed LPI tables (marc.zyngier@arm.com)
  + [d7fe00c] [2018-07-27] irqchip/gic-v3-its: Keep track of property table's PA and VA (marc.zyngier@arm.com)
  + [db50174] [2018-07-27] irqchip/gic-v3-its: Move pending table allocation to init time (marc.zyngier@arm.com)
  + [43de5b5] [2018-07-27] irqchip/gic-v3-its: Split property table clearing from allocation (marc.zyngier@arm.com)
  + [309f419] [2018-07-17] irqchip/gic-v3-its: Simplify LPI_PENDBASE_SZ usage (marc.zyngier@arm.com)
  + [4ce61ab] [2018-07-27] irqchip/gic-v3-its: Change initialization ordering for LPIs (marc.zyngier@arm.com)
  + [3e5360c] [2018-03-21] irqchip/gic-v3: Ensure GICR_CTLR.EnableLPI=0 is observed before enabling (shankerd@codeaurora.org)
  + [fc7292f] [2019-12-06] efi/memreserve: Register reservations as 'reserved' in /proc/iomem (ardb@kernel.org)
  + [c30bb24] [2019-06-09] efi/memreserve: deal with memreserve entries in unmapped memory (ard.biesheuvel@linaro.org)
  + [0035e84] [2018-11-29] efi: Reduce the amount of memblock reservations for persistent allocations (ard.biesheuvel@linaro.org)
  + [dfa68b6] [2018-11-29] efi: Permit multiple entries in persistent memreserve data structure (ard.biesheuvel@linaro.org)
  + [e6626a6] [2018-11-23] efi: Prevent GICv3 WARN() by mapping the memreserve table before first use (ard.biesheuvel@linaro.org)
  + [4023e14] [2018-11-14] efi: Permit calling efi_mem_reserve_persistent() from atomic context (ard.biesheuvel@linaro.org)
  + [4e87567] [2018-09-21] efi: add API to reserve memory persistently across kexec reboot (ard.biesheuvel@linaro.org)
  + [1a98513] [2018-09-21] efi/arm: libstub: add a root memreserve config table (ard.biesheuvel@linaro.org)
  + [e9023eb] [2018-09-21] efi: honour memory reservations passed via a linux specific config table (ard.biesheuvel@linaro.org)
  + [acd6497] [2020-04-07] kernel/sched/fair.c: Fix divide by zero (sblbir@amazon.com)
  + [2c49aca] [2020-04-01] Revert "ena: update to 2.2.3" (yishache@amazon.com)
  + [4808b21] [2020-03-08] lustre: update to AmazonFSxLustreClient v2.10.8-1 (astroh@amazon.com)
  + [c63109c] [2020-01-29] random: introduce RANDOM_WAIT_JITTER config option (fllinden@amazon.com)
  + [4f4dee6] [2019-09-28] random: try to actively add entropy rather than passively wait for it (torvalds@linux-foundation.org)
  + [c4de2e8] [2020-02-26] ena: update to 2.2.3 (fllinden@amazon.com)
  + [97aceb7] [2019-06-26] perf: arm_spe: Enable ACPI/Platform automatic module loading (jeremy.linton@arm.com)
  + [a2e8441] [2019-06-26] arm_pmu: acpi: spe: Add initial MADT/SPE probing (jeremy.linton@arm.com)
  + [8e3eef90] [2019-06-26] ACPI/PPTT: Add function to return ACPI 6.3 Identical tokens (jeremy.linton@arm.com)
  + [452bcdf] [2019-06-26] ACPI/PPTT: Modify node flag detection to find last IDENTICAL (jeremy.linton@arm.com)
  + [e590eb2] [2020-01-29] ACPICA: ACPI 6.3: PPTT add additional fields in Processor Structure Flags (erik.schmauss@intel.com)
  + [2393ac6] [2020-01-28] ACPICA: ACPI 6.3: MADT: add support for statistical profiling in GICC (erik.schmauss@intel.com)
  + [7090613] [2018-08-10] perf arm spe: Fix uninitialized record error variable (kim.phillips@arm.com)
  + [2e7a3e3] [2018-01-14] perf tools: Add ARM Statistical Profiling Extensions (SPE) support (kim.phillips@arm.com)
  + [f4aeacc] [2016-09-22] drivers/perf: Add support for ARMv8.2 Statistical Profiling Extension (will.deacon@arm.com)
  + [d659990] [2016-09-22] dt-bindings: Document devicetree binding for ARM SPE (will.deacon@arm.com)
  + [0cd014e] [2017-07-07] arm64: head: Init PMSCR_EL2.{PA,PCT} when entered at EL2 without VHE (will.deacon@arm.com)
  + [9234bca] [2017-09-20] arm64: sysreg: Move SPE registers and PSB into common header files (will.deacon@arm.com)
  + [83d1a35] [2016-09-23] perf/core: Add PERF_AUX_FLAG_COLLISION to report colliding samples (will.deacon@arm.com)
  + [8430f49] [2016-08-16] perf/core: Export AUX buffer helpers to modules (will.deacon@arm.com)
  + [d6d805b] [2016-07-25] genirq: export irq_get_percpu_devid_partition to modules (will.deacon@arm.com)
  + [457a02b] [2018-03-29] Don't log confusing message on reconnect by default (stfrench@microsoft.com)
  + [75d34e9] [2018-03-21] Don't log expected error on DFS referral request (smfrench@gmail.com)
  + [38795be] [2017-11-21] CIFS: don't log STATUS_NOT_FOUND errors for DFS (aaptel@suse.com)
  + [8546697] [2018-07-05] cifs: Fix slab-out-of-bounds in send_set_info() on SMB2 ACE setting (sbrivio@redhat.com)
  + [4303e07] [2019-12-31] lib/list-test: add a test for the 'list' doubly linked list (davidgow@google.com)
  + [18b2cdb] [2019-09-08] Documentation: kunit: Fix verification command (sj38.park@gmail.com)
  + [c2d8d32] [2019-09-23] Documentation: kunit: add documentation for KUnit (brendanhiggins@google.com)
  + [ae4a983] [2019-09-07] kunit: Fix '--build_dir' option (sj38.park@gmail.com)
  + [873d3af] [2019-09-23] kunit: defconfig: add defconfigs for building KUnit tests (brendanhiggins@google.com)
  + [a6bf792] [2019-09-23] kunit: tool: add Python wrappers for running KUnit tests (felixguoxiuping@gmail.com)
  + [8f1b6bb] [2019-09-23] kunit: fix failure to build without printk (brendanhiggins@google.com)
  + [354f227] [2019-09-23] kunit: test: add tests for KUnit managed resources (akndr41@gmail.com)
  + [3c1105a] [2019-09-23] kunit: test: add the concept of assertions (brendanhiggins@google.com)
  + [1ca1e25] [2019-09-23] kunit: test: add tests for kunit test abort (brendanhiggins@google.com)
  + [980320c] [2019-09-23] kunit: test: add support for test abort (brendanhiggins@google.com)
  + [8258d2f] [2019-09-23] kunit: test: add initial tests (brendanhiggins@google.com)
  + [0c16fb7] [2019-12-31] lib: enable building KUnit in lib/ (brendanhiggins@google.com)
  + [f265420] [2019-09-23] kunit: test: add the concept of expectations (brendanhiggins@google.com)
  + [85e5a96] [2019-09-23] kunit: test: add assertion printing library (brendanhiggins@google.com)
  + [8ef3cac] [2019-09-23] kunit: test: add string_stream a std::stream like string builder (brendanhiggins@google.com)
  + [552be4c] [2019-09-23] kunit: test: add test resource management API (brendanhiggins@google.com)
  + [98fa2c7] [2019-09-23] kunit: test: add KUnit test runner core (brendanhiggins@google.com)
  + [40a582b] [2020-02-03] Revert "update ENA linux driver to version 2.2.1" (anchalag@amazon.com)
  + [4be22fa] [2020-01-20] update ENA linux driver to version 2.2.1 (anchalag@amazon.com)
  + [6b56cf4] [2019-12-18] Add support for setting owner info, dos attributes, and create time (bprotopopov@hotmail.com)
  + [1d6f1b8] [2018-08-28] SMB3: Backup intent flag missing from compounded ops (stfrench@microsoft.com)
  + [89a1b14] [2019-12-19] drivers/amazon: efa: update to 1.5.0 (luqia@amazon.com)
  + [43fb33e] [2019-12-16] Revert "Fix the locking in dcache_readdir() and friends". (fllinden@amazon.com)
  + [601cbae] [2019-12-04] lustre: hold lock while walking changelog dev list (astroh@amazon.com)
  + [1e3f104] [2019-11-15] arm64: fix merge error in errata changes (fllinden@amazon.com)
  + [8c5db70] [2019-11-12] nvme-pci: use atomic bitops to mark a queue enabled (hch@lst.de)
  + [5043391] [2019-11-11] nvme-pci: Don't disable on timeout in reset state (keith.busch@intel.com)
  + [f786eeb] [2019-11-11] nvme-pci: Unblock reset_work on IO failure (keith.busch@intel.com)
  + [74e5c27] [2019-11-11] nvme-pci: shutdown on timeout during deletion (keith.busch@intel.com)
  + [22c1c86] [2018-02-08] nvme-pci: Fix timeouts in connecting state (keith.busch@intel.com)
  + [6b5768e] [2019-11-11] nvme: rename NVME_CTRL_RECONNECTING state to NVME_CTRL_CONNECTING (maxg@mellanox.com)
  + [2a93cde] [2017-10-25] nvme: allow controller RESETTING to RECONNECTING transition (jsmart2021@gmail.com)
  + [12262ce] [2019-11-11] nvme-pci: introduce RECONNECTING state to mark initializing procedure (jianchao.w.wang@oracle.com)
  + [868b4b7] [2019-11-11] Revert "nvme/pci: Better support for disabling controller" (sblbir@amazon.com)
  + [1f11a64] [2019-11-04] update ena driver to version 2.1.3 (alakeshh@amazon.com)
  + [28dcef9] [2018-06-22] arm64: Avoid flush_icache_range() in alternatives patching code (will.deacon@arm.com)
  + [07bf9ae] [2018-09-27] arm64: pull in upstream erratum workarounds (fllinden@amazon.com)
  + [d6051a2] [2018-03-13] arm64: kconfig: Ensure spinlock fastpaths are inlined if !PREEMPT (will.deacon@arm.com)
  + [c04ec01] [2018-03-13] arm64: locking: Replace ticket lock implementation with qspinlock (will.deacon@arm.com)
  + [14329e8] [2018-01-31] arm64: barrier: Implement smp_cond_load_relaxed (will.deacon@arm.com)
  + [2e15c59] [2018-04-26] MAINTAINERS: Add myself as a co-maintainer for the locking subsystem (will.deacon@arm.com)
  + [34fa03e] [2018-04-26] locking/qspinlock: Use try_cmpxchg() instead of cmpxchg() when locking (will.deacon@arm.com)
  + [98b96bc] [2018-04-26] locking/qspinlock: Elide back-to-back RELEASE operations with smp_wmb() (will.deacon@arm.com)
  + [da64dea] [2018-04-26] locking/qspinlock: Use smp_store_release() in queued_spin_unlock() (will.deacon@arm.com)
  + [bcd15f4] [2018-04-26] locking/qspinlock: Use smp_cond_load_relaxed() to wait for next node (will.deacon@arm.com)
  + [74e403c] [2018-04-26] locking/mcs: Use smp_cond_load_acquire() in MCS spin loop (jason.low2@hp.com)
  + [7ddc7992] [2018-04-26] locking/qspinlock: Use atomic_cond_read_acquire() (will.deacon@arm.com)
  + [c892987] [2018-04-26] locking/barriers: Introduce smp_cond_load_relaxed() and atomic_cond_read_relaxed() (will.deacon@arm.com)
  + [95fdaef] [2017-10-12] locking/atomic: Add atomic_cond_read_acquire() (will.deacon@arm.com)
  + [86f5cce] [2019-08-29] iommu: use config option to specify if iommu mode should be strict (fllinden@amazon.com)
  + [124e384] [2018-09-20] iommu/arm-smmu: Support non-strict mode (robin.murphy@arm.com)
  + [363abb2] [2018-09-20] iommu/io-pgtable-arm-v7s: Add support for non-strict mode (robin.murphy@arm.com)
  + [859a524] [2018-09-20] iommu/arm-smmu-v3: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [04f59bc] [2018-09-20] iommu/io-pgtable-arm: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [0e7e6eb] [2018-09-20] iommu: Add "iommu.strict" command line option (thunder.leizhen@huawei.com)
  + [6cffbce] [2018-09-20] iommu/dma: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [95b11b9] [2018-09-20] iommu/arm-smmu-v3: Implement flush_iotlb_all hook (thunder.leizhen@huawei.com)
  + [cb39d51] [2017-09-28] iommu/io-pgtable-arm-v7s: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [225d312] [2017-09-28] iommu/io-pgtable-arm: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [c1f0afa] [2019-03-12] irqchip/gic-v3-its: Fix comparison logic in lpi_range_cmp (linux@rasmusvillemoes.dk)
  + [ddf5968] [2019-01-29] irqchip/gic-v3-its: Gracefully fail on LPI exhaustion (marc.zyngier@arm.com)
  + [65e392d] [2018-08-28] irqchip/gic-v3-its: Cap lpi_id_bits to reduce memory footprint (jia.he@hxt-semitech.com)
  + [84a18b71] [2018-05-31] irqchip/gic-v3-its: Reduce minimum LPI allocation to 1 for PCI devices (marc.zyngier@arm.com)
  + [6cfce14] [2018-05-31] irqchip/gic-v3-its: Honor hypervisor enforced LPI range (marc.zyngier@arm.com)
  + [966e7bc] [2018-05-30] irqchip/gic-v3: Expose GICD_TYPER in the rdist structure (marc.zyngier@arm.com)
  + [7dfe4dc] [2018-05-27] irqchip/gic-v3-its: Drop chunk allocation compatibility (marc.zyngier@arm.com)
  + [1a728ea] [2018-05-27] irqchip/gic-v3-its: Move minimum LPI requirements to individual busses (marc.zyngier@arm.com)
  + [c4a59b0] [2018-05-27] irqchip/gic-v3-its: Use full range of LPIs (marc.zyngier@arm.com)
  + [6454b22] [2018-05-27] irqchip/gic-v3-its: Refactor LPI allocator (marc.zyngier@arm.com)
  + [367d4ad] [2018-06-22] irqchip/gic-v3-its: Only emit VSYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [1d31ba7] [2018-06-22] irqchip/gic-v3-its: Only emit SYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [3880519] [2017-07-28] irqchip/gic-v3-its: Pass its_node pointer to each command builder (marc.zyngier@arm.com)
  + [d8fc61a] [2018-05-17] nvme-pci: move ->cq_vector == -1 check outside of ->q_lock (axboe@kernel.dk)
  + [1c847b9] [2019-09-13] nvme/host/pci: Fix a race in controller removal (sblbir@amzn.com)
  + [dd3c8a6] [2019-09-13] nvme/host/core: Allow overriding of wait_ready timeout (sblbir@amzn.com)
  + [1a7b1ad] [2019-09-10] nvme/pci: Better support for disabling controller (sblbir@amzn.com)
  + [0b3562c] [2017-11-02] nvme: move the dying queue check from cancel to completion (hch@lst.de)
  + [3eba3a2] [2019-08-28] blk-mq: fix hang caused by freeze/unfreeze sequence (bob.liu@oracle.com)
  + [261344cbd] [2019-08-16] nvme: change namespaces_mutext to namespaces_rwsem (jianchao.w.wang@oracle.com)
  + [d52efff] [2018-09-26] block: Allow unfreezing of a queue while requests are in progress (bvanassche@acm.org)
  + [9a0312f] [2019-08-16] percpu-refcount: Introduce percpu_ref_resurrect() (bvanassche@acm.org)
  + [9e218f1] [2019-09-05] Add Amazon EFA driver version 1.4 (alakeshh@amazon.com)
  + [d2f043e] [2019-04-02] block: don't show io_timeout if driver has no timeout handler (zhangweiping@didiglobal.com)
  + [4664613] [2018-11-29] block: add io timeout to sysfs (zhangweiping@didiglobal.com)
  + [5764eae] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [f87f58b7] [2019-01-09] livepatch: Change unsigned long old_addr -> void *old_func in struct klp_func (pmladek@suse.com)
  + [862fd7f] [2018-11-07] livepatch: Replace synchronize_sched() with synchronize_rcu() (paulmck@linux.ibm.com)
  + [fded6978] [2018-07-12] livepatch: Remove reliable stacktrace check in klp_try_switch_task() (kamalesh@linux.vnet.ibm.com)
  + [fb9c66e] [2018-04-16] livepatch: Allow to call a custom callback when freeing shadow variables (pmladek@suse.com)
  + [0ec5f1e] [2018-04-16] livepatch: Initialize shadow variables safely by a custom callback (pmladek@suse.com)
  + [02d0888] [2017-12-21] livepatch: add locking to force and signal functions (mbenes@suse.cz)
  + [8a74876] [2018-01-10] livepatch: Remove immediate feature (mbenes@suse.cz)
  + [827df11] [2017-11-22] livepatch: force transition to finish (mbenes@suse.cz)
  + [a50b14f] [2017-11-15] livepatch: send a fake signal to all blocking tasks (mbenes@suse.cz)
  + [9744c5a] [2017-10-20] livepatch: __klp_disable_patch() should never be called for disabled patches (pmladek@suse.com)
  + [6cb3b66] [2017-10-20] livepatch: Correctly call klp_post_unpatch_callback() in error paths (pmladek@suse.com)
  + [c25f4a6] [2017-10-13] livepatch: add transition notices (joe.lawrence@redhat.com)
  + [b7bf1cf] [2017-10-13] livepatch: move transition "complete" notice into klp_complete_transition() (joe.lawrence@redhat.com)
  + [534d427] [2017-10-13] livepatch: add (un)patch callbacks (joe.lawrence@redhat.com)
  + [4dfd98d] [2017-09-14] livepatch: __klp_shadow_get_or_alloc() is local to shadow.c (jkosina@suse.cz)
  + [2d76d64] [2017-08-31] livepatch: introduce shadow variable API (joe.lawrence@redhat.com)
  + [edc6e3b] [2019-08-15] Partially revert cc946adcb9e983ad9fe56ebe35f1292e111ff10e (sblbir@amzn.com)
  + [d4716bd] [2019-07-11] PCI: Add ACS quirk for Amazon Annapurna Labs root ports (alisaidi@amazon.com)
  + [c3f9599] [2019-07-11] PCI: Add Amazon's Annapurna Labs vendor ID (jonnyc@amazon.com)
  + [f8de287] [2019-06-24] linux/ena: update ENA linux driver to version 2.1.1 (fllinden@amazon.com)
  + [7df3e55] [2019-07-02] microvm: enable debug in case of tcp out of memory (alakeshh@amazon.com)
  + [a087f8d] [2019-07-03] Fix microvm config dependency in Kconfig (alakeshh@amazon.com)
  + [2da74b1] [2019-02-12] NFS: Remove redundant semicolon (zhangliguang@linux.alibaba.com)
  + [2a89c1e] [2019-05-31] arm64: acpi/pci: invoke _DSM whether to preserve firmware PCI setup (fllinden@amazon.com)
  + [185279d] [2019-03-28] PCI: al: Add Amazon Annapurna Labs PCIe host controller driver (jonnyc@amazon.com)
  + [c575c41] [2019-04-24] irqchip/gic-v2m: invoke from gic-v3 initialization and add acpi quirk flow (zeev@amazon.com)
  + [680ff9a] [2019-04-03] lustre: fix ACL handling (fllinden@amazon.com)
  + [046a389] [2018-05-18] x86/stacktrace: Enable HAVE_RELIABLE_STACKTRACE for the ORC unwinder (jslaby@suse.cz)
  + [1907ac7] [2018-05-18] x86/unwind/orc: Detect the end of the stack (jpoimboe@redhat.com)
  + [f94298d] [2018-05-18] x86/stacktrace: Do not fail for ORC with regs on stack (jslaby@suse.cz)
  + [f4301bf] [2018-05-18] x86/stacktrace: Clarify the reliable success paths (jslaby@suse.cz)
  + [0150fd7] [2018-05-18] x86/stacktrace: Remove STACKTRACE_DUMP_ONCE (jslaby@suse.cz)
  + [04c5191] [2018-05-18] x86/stacktrace: Do not unwind after user regs (jslaby@suse.cz)
  + [59d7425] [2019-03-12] Add new config CONFIG_MICROVM to enable microvm optimized kernel (alakeshh@amazon.com)
  + [49bdedc] [2019-02-19] tcp: Namespace-ify sysctl_tcp_rmem and sysctl_tcp_wmem (edumazet@google.com)
  + [53ed5cd] [2017-11-07] net: allow per netns sysctl_rmem and sysctl_wmem for protos (edumazet@google.com)
  + [4b1945d] [2019-03-01] Config glue for lustre client. (fllinden@amazon.com)
  + [0374f99] [2019-03-01] Import lustre client 2.10.5 (fllinden@amazon.com)
  + [7d899cf] [2018-06-05] iomap: fsync swap files before iterating mappings (darrick.wong@oracle.com)
  + [e673715] [2018-06-01] iomap: inline data should be an iomap type, not a flag (hch@lst.de)
  + [f6be915] [2018-05-16] iomap: don't allow holes in swapfiles (osandov@fb.com)
  + [05b397cb] [2018-05-16] iomap: provide more useful errors for invalid swap files (osandov@fb.com)
  + [acd5882] [2018-05-10] iomap: add a swapfile activation function (darrick.wong@oracle.com)
  + [2032e50] [2019-01-30] xfs, iomap: define and use the IOMAP_F_DIRTY flag in xfs (fllinden@amazon.com)
  + [7ccde98] [2018-08-01] xfs: only validate summary counts on primary superblock (darrick.wong@oracle.com)
  + [2151cbf] [2018-07-26] libxfs: add more bounds checking to sb sanity checks (billodo@redhat.com)
  + [20ac708] [2018-07-29] xfs: refactor superblock verifiers (darrick.wong@oracle.com)
  + [aa4bd01] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [7006520] [2018-10-04] ACPI/PPTT: Handle architecturally unknown cache types (jhugo@codeaurora.org)
  + [cc08f7e] [2018-06-05] ACPI / PPTT: fix build when CONFIG_ACPI_PPTT is not enabled (sudeep.holla@arm.com)
  + [3e36772] [2018-06-29] ACPI / PPTT: use ACPI ID whenever ACPI_PPTT_ACPI_PROCESSOR_ID_VALID is set (Sudeep.Holla@arm.com)
  + [5391559] [2018-05-11] arm64: topology: divorce MC scheduling domain from core_siblings (jeremy.linton@arm.com)
  + [0d1e7fd] [2018-05-11] ACPI: Add PPTT to injectable table list (jeremy.linton@arm.com)
  + [26cadad] [2018-05-11] arm64: topology: enable ACPI/PPTT based CPU topology (jeremy.linton@arm.com)
  + [efb053d] [2018-05-11] arm64: topology: rename cluster_id (jeremy.linton@arm.com)
  + [982356f] [2018-05-11] arm64: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [0993795] [2018-05-11] drivers: base cacheinfo: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [b1f8e61] [2018-05-11] ACPI: Enable PPTT support on ARM64 (jeremy.linton@arm.com)
  + [d337cdf] [2018-05-11] ACPI/PPTT: Add Processor Properties Topology Table parsing (jeremy.linton@arm.com)
  + [fcf170d] [2018-05-11] arm64/acpi: Create arch specific cpu to acpi id helper (jeremy.linton@arm.com)
  + [1290b33] [2018-05-11] cacheinfo: rename of_node to fw_token (jeremy.linton@arm.com)
  + [7e495d2] [2018-05-11] drivers: base: cacheinfo: setup DT cache properties early (jeremy.linton@arm.com)
  + [7a80dec] [2018-05-11] drivers: base: cacheinfo: move cache_setup_of_node() (jeremy.linton@arm.com)
  + [2ef4f39] [2017-11-17] ACPICA: ACPI 6.2: Additional PPTT flags (jeremy.linton@arm.com)
  + [01a6f9e] [2018-07-23] arm64: acpi: fix alignment fault in accessing ACPI (takahiro.akashi@linaro.org)
  + [b58ad4c] [2018-07-02] arm64: kexec: always reset to EL2 if present (mark.rutland@arm.com)
  + [b378aea] [2018-03-08] efi/arm64: Check whether x18 is preserved by runtime services calls (ard.biesheuvel@linaro.org)
  + [9663f15] [2018-10-11] arm64: Fix /proc/iomem for reserved but not memory regions (will.deacon@arm.com)
  + [1fd308b] [2018-07-23] arm64: export memblock_reserve()d regions via /proc/iomem (james.morse@arm.com)
  + [4a353b0] [2018-11-10] net: ena: Import the ENA v2 driver (2.0.2g) (alakeshh@amazon.com)
  + [d280a5c] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [e2b1e73] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [7987870] [2018-10-29] ACPICA: Enable sleep button on ACPI legacy wake (anchalag@amazon.com)
  + [9e1a34d] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [b0becc2] [2017-11-30] vmxnet3: increase default rx ring sizes (skhare@vmware.com)
  + [62700cd] [2018-04-27] x86/CPU/AMD: Derive CPU topology from CPUID function 0xB when available (suravee.suthikulpanit@amd.com)
  + [0c93b18] [2017-09-07] sched/topology: Introduce NUMA identity node sched domain (suravee.suthikulpanit@amd.com)
  + [263340c] [2018-06-13] x86/CPU/AMD: Fix LLC ID bit-shift calculation (suravee.suthikulpanit@amd.com)
  + [6dbe09b] [2018-04-27] x86/CPU/AMD: Calculate last level cache ID from number of sharing threads (suravee.suthikulpanit@amd.com)
  + [d62d4b6] [2018-04-27] x86/CPU: Rename intel_cacheinfo.c to cacheinfo.c (bp@suse.de)
  + [4d03a4f] [2018-05-17] x86/MCE/AMD: Read MCx_MISC block addresses on any CPU (bp@suse.de)
  + [c9a433f] [2018-08-15] blk-wbt: Avoid lock contention and thundering herd issue in wbt_wait (anchalag@amazon.com)
  + [fc3413b] [2018-01-12] blk-mq: simplify queue mapping & schedule with each possisble CPU (hch@lst.de)
  + [31f908e] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [bbe1181] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [bf9fcea] [2018-03-24] KVM: X86: Fix setup the virt_spin_lock_key before static key get initialized (wanpengli@tencent.com)
  + [b2e5b45] [2017-10-28] x86/paravirt: Set up the virt_spin_lock_key after static keys get initialized (douly.fnst@cn.fujitsu.com)
  + [6e7c8a0] [2018-02-13] KVM: X86: Choose qspinlock when dedicated physical CPUs are available (wanpengli@tencent.com)
  + [e479ef2] [2018-02-13] KVM: Introduce paravirtualization hints and KVM_HINTS_DEDICATED (wanpengli@tencent.com)
  + [40637a2] [2017-09-06] locking/paravirt: Use new static key for controlling call of virt_spin_lock() (jgross@suse.com)
  + [4e84133] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [6406d6a] [2018-01-18] ACPI: SPCR: Make SPCR available to x86 (prarit@redhat.com)
  + [6f2b581] [2016-04-26] xen-blkfront: add 'persistent_grants' parameter (aliguori@amazon.com)
  + [7519642] [2017-03-10] xen-blkfront: resurrect request-based mode (kamatam@amazon.com)
  + [202680a] [2017-11-02] Not-for-upstream: PM / hibernate: Speed up hibernation by batching requests (cyberax@amazon.com)
  + [74294fc] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [c9c404f] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [887d37c] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [8fdadb6] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [8a5a05c] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [40e7ffc] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [b49507b] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [acd80d0] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [aafd1d4] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [1718955] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [ec2304c] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [a6f39e0] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [532891f] [2018-02-27] Importing Amazon ENA driver 1.5.0 into amazon-4.14.y/master. (vallish@amazon.com)
  + [75c8018] [2018-02-12] drivers/amazon: introduce AMAZON_ENA_ETHERNET (vallish@amazon.com)
  + [faabecf] [2018-02-12] drivers/amazon: add network device drivers support (vallish@amazon.com)
  + [7c27182] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [36711fa] [2017-10-27] not-for-upstream: testmgr config changes to enable FIPS boot (alakeshh@amazon.com)
  + [b0d0b58] [2017-09-19] nvme: update timeout module parameter type (vallish@amazon.com)
  + [de81ef16] [2015-12-08] force perf to use /usr/bin/python instead of /usr/bin/python2 (kamatam@amazon.com)
  + [69c328e] [2013-02-13] bump default tcp_wmem from 16KB to 20KB (gafton@amazon.com)
  + [8b9f950] [2016-01-26] bump the default TTL to 255 (kamatam@amazon.com)
  + [d7a15a5] [2012-02-10] scsi: sd_revalidate_disk prevent NULL ptr deref (kernel-team@fedoraproject.org)

...
Source0: linux-4.14.173.tar
Source1: linux-4.14.173-patches.tar
...
%changelog
* Wed Apr 01 2020 Builder <builder@amazon.com>
- builder/4338a85ccd37da68058b70cbf3a07d3ad290eec2 last changes:

- linux/6d424212c0b55737895069d17c323b508f42fdfe last changes:
  + [6d424212c0b5] [2020-04-01] Revert "ena: update to 2.2.3" (yishache@amazon.com)
  + [e6a938fca407] [2020-03-08] lustre: update to AmazonFSxLustreClient v2.10.8-1 (astroh@amazon.com)
  + [966ceb54a533] [2020-01-29] random: introduce RANDOM_WAIT_JITTER config option (fllinden@amazon.com)
  + [caa8f68dbc6a] [2019-09-28] random: try to actively add entropy rather than passively wait for it (torvalds@linux-foundation.org)
  + [95ffc60d40ab] [2020-02-26] ena: update to 2.2.3 (fllinden@amazon.com)
  + [4920642099d9] [2019-06-26] perf: arm_spe: Enable ACPI/Platform automatic module loading (jeremy.linton@arm.com)
  + [6913ef786036] [2019-06-26] arm_pmu: acpi: spe: Add initial MADT/SPE probing (jeremy.linton@arm.com)
  + [d63dca3eef01] [2019-06-26] ACPI/PPTT: Add function to return ACPI 6.3 Identical tokens (jeremy.linton@arm.com)
  + [b7d4a46af261] [2019-06-26] ACPI/PPTT: Modify node flag detection to find last IDENTICAL (jeremy.linton@arm.com)
  + [ae79dee05ba4] [2020-01-29] ACPICA: ACPI 6.3: PPTT add additional fields in Processor Structure Flags (erik.schmauss@intel.com)
  + [26c4b7f161b3] [2020-01-28] ACPICA: ACPI 6.3: MADT: add support for statistical profiling in GICC (erik.schmauss@intel.com)
  + [e15d40a5be95] [2018-08-10] perf arm spe: Fix uninitialized record error variable (kim.phillips@arm.com)
  + [6da425e9fb00] [2018-01-14] perf tools: Add ARM Statistical Profiling Extensions (SPE) support (kim.phillips@arm.com)
  + [9451adc44ffc] [2016-09-22] drivers/perf: Add support for ARMv8.2 Statistical Profiling Extension (will.deacon@arm.com)
  + [2982dde48097] [2016-09-22] dt-bindings: Document devicetree binding for ARM SPE (will.deacon@arm.com)
  + [6243c716a02d] [2017-07-07] arm64: head: Init PMSCR_EL2.{PA,PCT} when entered at EL2 without VHE (will.deacon@arm.com)
  + [2068bfa1f90c] [2017-09-20] arm64: sysreg: Move SPE registers and PSB into common header files (will.deacon@arm.com)
  + [f6d8f2aa35b8] [2016-09-23] perf/core: Add PERF_AUX_FLAG_COLLISION to report colliding samples (will.deacon@arm.com)
  + [87173e4e83e4] [2016-08-16] perf/core: Export AUX buffer helpers to modules (will.deacon@arm.com)
  + [261c482f0dd1] [2016-07-25] genirq: export irq_get_percpu_devid_partition to modules (will.deacon@arm.com)
  + [efe9f52e4575] [2018-03-29] Don't log confusing message on reconnect by default (stfrench@microsoft.com)
  + [f270e8c663bc] [2018-03-21] Don't log expected error on DFS referral request (smfrench@gmail.com)
  + [dadd8115f5fc] [2017-11-21] CIFS: don't log STATUS_NOT_FOUND errors for DFS (aaptel@suse.com)
  + [1732632490e3] [2018-07-05] cifs: Fix slab-out-of-bounds in send_set_info() on SMB2 ACE setting (sbrivio@redhat.com)
  + [f7617adb05d7] [2019-12-31] lib/list-test: add a test for the 'list' doubly linked list (davidgow@google.com)
  + [877c83867e44] [2019-09-08] Documentation: kunit: Fix verification command (sj38.park@gmail.com)
  + [cbae6953d161] [2019-09-23] Documentation: kunit: add documentation for KUnit (brendanhiggins@google.com)
  + [b29ae63e31e1] [2019-09-07] kunit: Fix '--build_dir' option (sj38.park@gmail.com)
  + [b56cadfd7294] [2019-09-23] kunit: defconfig: add defconfigs for building KUnit tests (brendanhiggins@google.com)
  + [0184f65b68a6] [2019-09-23] kunit: tool: add Python wrappers for running KUnit tests (felixguoxiuping@gmail.com)
  + [52ee9918b10f] [2019-09-23] kunit: fix failure to build without printk (brendanhiggins@google.com)
  + [8aea3432e630] [2019-09-23] kunit: test: add tests for KUnit managed resources (akndr41@gmail.com)
  + [28eda9282ee4] [2019-09-23] kunit: test: add the concept of assertions (brendanhiggins@google.com)
  + [9fcd57a83fb5] [2019-09-23] kunit: test: add tests for kunit test abort (brendanhiggins@google.com)
  + [e977db5f5ffe] [2019-09-23] kunit: test: add support for test abort (brendanhiggins@google.com)
  + [5ffbd7348d16] [2019-09-23] kunit: test: add initial tests (brendanhiggins@google.com)
  + [586f8241b609] [2019-12-31] lib: enable building KUnit in lib/ (brendanhiggins@google.com)
  + [bdf18e93d91d] [2019-09-23] kunit: test: add the concept of expectations (brendanhiggins@google.com)
  + [d78475d82cdb] [2019-09-23] kunit: test: add assertion printing library (brendanhiggins@google.com)
  + [ddd63297e2ab] [2019-09-23] kunit: test: add string_stream a std::stream like string builder (brendanhiggins@google.com)
  + [15c5a9175717] [2019-09-23] kunit: test: add test resource management API (brendanhiggins@google.com)
  + [020ea8b91d93] [2019-09-23] kunit: test: add KUnit test runner core (brendanhiggins@google.com)
  + [e18fbda298d1] [2020-02-03] Revert "update ENA linux driver to version 2.2.1" (anchalag@amazon.com)
  + [8461c09320d2] [2020-01-20] update ENA linux driver to version 2.2.1 (anchalag@amazon.com)
  + [e4ac1214dc0c] [2019-12-18] Add support for setting owner info, dos attributes, and create time (bprotopopov@hotmail.com)
  + [efe91ddaa047] [2018-08-28] SMB3: Backup intent flag missing from compounded ops (stfrench@microsoft.com)
  + [6d1e73382b19] [2019-12-19] drivers/amazon: efa: update to 1.5.0 (luqia@amazon.com)
  + [074a49903d9f] [2019-12-16] Revert "Fix the locking in dcache_readdir() and friends". (fllinden@amazon.com)
  + [1c5be64e9a77] [2019-12-04] lustre: hold lock while walking changelog dev list (astroh@amazon.com)
  + [25da7290099f] [2019-11-15] arm64: fix merge error in errata changes (fllinden@amazon.com)
  + [820110ee83b8] [2019-11-12] nvme-pci: use atomic bitops to mark a queue enabled (hch@lst.de)
  + [439abe31a4b8] [2019-11-11] nvme-pci: Don't disable on timeout in reset state (keith.busch@intel.com)
  + [e2232bbb73d9] [2019-11-11] nvme-pci: Unblock reset_work on IO failure (keith.busch@intel.com)
  + [33bd4f6f61a1] [2019-11-11] nvme-pci: shutdown on timeout during deletion (keith.busch@intel.com)
  + [05135cac8f68] [2018-02-08] nvme-pci: Fix timeouts in connecting state (keith.busch@intel.com)
  + [c70497c9aac5] [2019-11-11] nvme: rename NVME_CTRL_RECONNECTING state to NVME_CTRL_CONNECTING (maxg@mellanox.com)
  + [de824cdcc85f] [2017-10-25] nvme: allow controller RESETTING to RECONNECTING transition (jsmart2021@gmail.com)
  + [baaa1d0a7b29] [2019-11-11] nvme-pci: introduce RECONNECTING state to mark initializing procedure (jianchao.w.wang@oracle.com)
  + [eba7bc11d28a] [2019-11-11] Revert "nvme/pci: Better support for disabling controller" (sblbir@amazon.com)
  + [1e375a3deed7] [2019-11-04] update ena driver to version 2.1.3 (alakeshh@amazon.com)
  + [7e758daf8e71] [2018-06-22] arm64: Avoid flush_icache_range() in alternatives patching code (will.deacon@arm.com)
  + [58e707f1cc1c] [2018-09-27] arm64: pull in upstream erratum workarounds (fllinden@amazon.com)
  + [9ee7745e6a9b] [2018-03-13] arm64: kconfig: Ensure spinlock fastpaths are inlined if !PREEMPT (will.deacon@arm.com)
  + [fafbc38e980f] [2018-03-13] arm64: locking: Replace ticket lock implementation with qspinlock (will.deacon@arm.com)
  + [5494102fabca] [2018-01-31] arm64: barrier: Implement smp_cond_load_relaxed (will.deacon@arm.com)
  + [93eeff4e82e8] [2018-04-26] MAINTAINERS: Add myself as a co-maintainer for the locking subsystem (will.deacon@arm.com)
  + [8a50da794570] [2018-04-26] locking/qspinlock: Use try_cmpxchg() instead of cmpxchg() when locking (will.deacon@arm.com)
  + [f431cd146a3f] [2018-04-26] locking/qspinlock: Elide back-to-back RELEASE operations with smp_wmb() (will.deacon@arm.com)
  + [4ddccd3cde5f] [2018-04-26] locking/qspinlock: Use smp_store_release() in queued_spin_unlock() (will.deacon@arm.com)
  + [f63c21a1d7ab] [2018-04-26] locking/qspinlock: Use smp_cond_load_relaxed() to wait for next node (will.deacon@arm.com)
  + [7ab3ac0c1f87] [2018-04-26] locking/mcs: Use smp_cond_load_acquire() in MCS spin loop (jason.low2@hp.com)
  + [7592df379291] [2018-04-26] locking/qspinlock: Use atomic_cond_read_acquire() (will.deacon@arm.com)
  + [85f8885c1b23] [2018-04-26] locking/barriers: Introduce smp_cond_load_relaxed() and atomic_cond_read_relaxed() (will.deacon@arm.com)
  + [40ffd803c77d] [2017-10-12] locking/atomic: Add atomic_cond_read_acquire() (will.deacon@arm.com)
  + [ff10a75c9ef8] [2019-08-29] iommu: use config option to specify if iommu mode should be strict (fllinden@amazon.com)
  + [2707417ec9d4] [2018-09-20] iommu/arm-smmu: Support non-strict mode (robin.murphy@arm.com)
  + [0a484b8740ca] [2018-09-20] iommu/io-pgtable-arm-v7s: Add support for non-strict mode (robin.murphy@arm.com)
  + [d6a4a388fcde] [2018-09-20] iommu/arm-smmu-v3: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [26e8ddabd43b] [2018-09-20] iommu/io-pgtable-arm: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [1664d6288135] [2018-09-20] iommu: Add "iommu.strict" command line option (thunder.leizhen@huawei.com)
  + [1a401e7a2ba4] [2018-09-20] iommu/dma: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [060c7977d5ba] [2018-09-20] iommu/arm-smmu-v3: Implement flush_iotlb_all hook (thunder.leizhen@huawei.com)
  + [3d4db5356914] [2017-09-28] iommu/io-pgtable-arm-v7s: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [88b48e6c39b0] [2017-09-28] iommu/io-pgtable-arm: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [d30815cd2089] [2019-03-12] irqchip/gic-v3-its: Fix comparison logic in lpi_range_cmp (linux@rasmusvillemoes.dk)
  + [1953e537967d] [2019-01-29] irqchip/gic-v3-its: Gracefully fail on LPI exhaustion (marc.zyngier@arm.com)
  + [be65ceb3f306] [2018-08-28] irqchip/gic-v3-its: Cap lpi_id_bits to reduce memory footprint (jia.he@hxt-semitech.com)
  + [d7bf9513306c] [2018-05-31] irqchip/gic-v3-its: Reduce minimum LPI allocation to 1 for PCI devices (marc.zyngier@arm.com)
  + [76332327d108] [2018-05-31] irqchip/gic-v3-its: Honor hypervisor enforced LPI range (marc.zyngier@arm.com)
  + [991b9dda0f97] [2018-05-30] irqchip/gic-v3: Expose GICD_TYPER in the rdist structure (marc.zyngier@arm.com)
  + [4575e3f5fad0] [2018-05-27] irqchip/gic-v3-its: Drop chunk allocation compatibility (marc.zyngier@arm.com)
  + [7861e07af08b] [2018-05-27] irqchip/gic-v3-its: Move minimum LPI requirements to individual busses (marc.zyngier@arm.com)
  + [193a21e28f5f] [2018-05-27] irqchip/gic-v3-its: Use full range of LPIs (marc.zyngier@arm.com)
  + [17935743bbb7] [2018-05-27] irqchip/gic-v3-its: Refactor LPI allocator (marc.zyngier@arm.com)
  + [442a4ca51a45] [2018-06-22] irqchip/gic-v3-its: Only emit VSYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [0571be85e909] [2018-06-22] irqchip/gic-v3-its: Only emit SYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [f16452dcba8a] [2017-07-28] irqchip/gic-v3-its: Pass its_node pointer to each command builder (marc.zyngier@arm.com)
  + [b06206c780d8] [2018-05-17] nvme-pci: move ->cq_vector == -1 check outside of ->q_lock (axboe@kernel.dk)
  + [2437b50be87a] [2019-09-13] nvme/host/pci: Fix a race in controller removal (sblbir@amzn.com)
  + [034d51871ad1] [2019-09-13] nvme/host/core: Allow overriding of wait_ready timeout (sblbir@amzn.com)
  + [26aeb0156934] [2019-09-10] nvme/pci: Better support for disabling controller (sblbir@amzn.com)
  + [f5b738f16cf8] [2017-11-02] nvme: move the dying queue check from cancel to completion (hch@lst.de)
  + [5b248a362898] [2019-08-28] blk-mq: fix hang caused by freeze/unfreeze sequence (bob.liu@oracle.com)
  + [6cc2020a663d] [2019-08-16] nvme: change namespaces_mutext to namespaces_rwsem (jianchao.w.wang@oracle.com)
  + [780a577b6996] [2018-09-26] block: Allow unfreezing of a queue while requests are in progress (bvanassche@acm.org)
  + [cf278953b10a] [2019-08-16] percpu-refcount: Introduce percpu_ref_resurrect() (bvanassche@acm.org)
  + [09a360156d6f] [2019-09-05] Add Amazon EFA driver version 1.4 (alakeshh@amazon.com)
  + [a5a9294b2bf2] [2019-04-02] block: don't show io_timeout if driver has no timeout handler (zhangweiping@didiglobal.com)
  + [37eb925e896b] [2018-11-29] block: add io timeout to sysfs (zhangweiping@didiglobal.com)
  + [ff86c00d0b7a] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [8eda5f95f4b2] [2019-01-09] livepatch: Change unsigned long old_addr -> void *old_func in struct klp_func (pmladek@suse.com)
  + [4e154fca753f] [2018-11-07] livepatch: Replace synchronize_sched() with synchronize_rcu() (paulmck@linux.ibm.com)
  + [0e631f4094b7] [2018-07-12] livepatch: Remove reliable stacktrace check in klp_try_switch_task() (kamalesh@linux.vnet.ibm.com)
  + [ea3ca8807dca] [2018-04-16] livepatch: Allow to call a custom callback when freeing shadow variables (pmladek@suse.com)
  + [2ca333a43e64] [2018-04-16] livepatch: Initialize shadow variables safely by a custom callback (pmladek@suse.com)
  + [dd465f67493c] [2017-12-21] livepatch: add locking to force and signal functions (mbenes@suse.cz)
  + [1a881ad6a5b0] [2018-01-10] livepatch: Remove immediate feature (mbenes@suse.cz)
  + [96c111d56811] [2017-11-22] livepatch: force transition to finish (mbenes@suse.cz)
  + [7a5df914f1ea] [2017-11-15] livepatch: send a fake signal to all blocking tasks (mbenes@suse.cz)
  + [3476ea2098d6] [2017-10-20] livepatch: __klp_disable_patch() should never be called for disabled patches (pmladek@suse.com)
  + [7c4f7253c29a] [2017-10-20] livepatch: Correctly call klp_post_unpatch_callback() in error paths (pmladek@suse.com)
  + [6c0042f19916] [2017-10-13] livepatch: add transition notices (joe.lawrence@redhat.com)
  + [83c197ac47c4] [2017-10-13] livepatch: move transition "complete" notice into klp_complete_transition() (joe.lawrence@redhat.com)
  + [4e770d9a3214] [2017-10-13] livepatch: add (un)patch callbacks (joe.lawrence@redhat.com)
  + [3f55215d5dfb] [2017-09-14] livepatch: __klp_shadow_get_or_alloc() is local to shadow.c (jkosina@suse.cz)
  + [021d0ed7276a] [2017-08-31] livepatch: introduce shadow variable API (joe.lawrence@redhat.com)
  + [e53afb9e736d] [2019-08-15] Partially revert cc946adcb9e983ad9fe56ebe35f1292e111ff10e (sblbir@amzn.com)
  + [23ad41f89882] [2019-07-11] PCI: Add ACS quirk for Amazon Annapurna Labs root ports (alisaidi@amazon.com)
  + [de1350f0a6e3] [2019-07-11] PCI: Add Amazon's Annapurna Labs vendor ID (jonnyc@amazon.com)
  + [f202dffdc58e] [2019-06-24] linux/ena: update ENA linux driver to version 2.1.1 (fllinden@amazon.com)
  + [9067e40d72f2] [2019-07-02] microvm: enable debug in case of tcp out of memory (alakeshh@amazon.com)
  + [5516d3ad1212] [2019-07-03] Fix microvm config dependency in Kconfig (alakeshh@amazon.com)
  + [7e520dcc7512] [2019-02-12] NFS: Remove redundant semicolon (zhangliguang@linux.alibaba.com)
  + [04b195368baf] [2019-05-31] arm64: acpi/pci: invoke _DSM whether to preserve firmware PCI setup (fllinden@amazon.com)
  + [8884c4b8ddbe] [2019-03-28] PCI: al: Add Amazon Annapurna Labs PCIe host controller driver (jonnyc@amazon.com)
  + [854143d0891b] [2019-04-24] irqchip/gic-v2m: invoke from gic-v3 initialization and add acpi quirk flow (zeev@amazon.com)
  + [7f83c60044f3] [2019-04-03] lustre: fix ACL handling (fllinden@amazon.com)
  + [03f922f88c55] [2018-05-18] x86/stacktrace: Enable HAVE_RELIABLE_STACKTRACE for the ORC unwinder (jslaby@suse.cz)
  + [4dce0882fe25] [2018-05-18] x86/unwind/orc: Detect the end of the stack (jpoimboe@redhat.com)
  + [f999c40ab4c7] [2018-05-18] x86/stacktrace: Do not fail for ORC with regs on stack (jslaby@suse.cz)
  + [19a07fb579a2] [2018-05-18] x86/stacktrace: Clarify the reliable success paths (jslaby@suse.cz)
  + [071f06048d65] [2018-05-18] x86/stacktrace: Remove STACKTRACE_DUMP_ONCE (jslaby@suse.cz)
  + [6405052f59b5] [2018-05-18] x86/stacktrace: Do not unwind after user regs (jslaby@suse.cz)
  + [e90b68901926] [2019-03-12] Add new config CONFIG_MICROVM to enable microvm optimized kernel (alakeshh@amazon.com)
  + [d123ccd71cab] [2019-02-19] tcp: Namespace-ify sysctl_tcp_rmem and sysctl_tcp_wmem (edumazet@google.com)
  + [f24e717ce88d] [2017-11-07] net: allow per netns sysctl_rmem and sysctl_wmem for protos (edumazet@google.com)
  + [de689d0831e7] [2019-03-01] Config glue for lustre client. (fllinden@amazon.com)
  + [38b87d459b4c] [2019-03-01] Import lustre client 2.10.5 (fllinden@amazon.com)
  + [328ffc3027bc] [2018-06-05] iomap: fsync swap files before iterating mappings (darrick.wong@oracle.com)
  + [6f9308764cf9] [2018-06-01] iomap: inline data should be an iomap type, not a flag (hch@lst.de)
  + [19145fab1ea7] [2018-05-16] iomap: don't allow holes in swapfiles (osandov@fb.com)
  + [7a7067d7c838] [2018-05-16] iomap: provide more useful errors for invalid swap files (osandov@fb.com)
  + [9c472062d2e4] [2018-05-10] iomap: add a swapfile activation function (darrick.wong@oracle.com)
  + [519aacfb9236] [2019-01-30] xfs, iomap: define and use the IOMAP_F_DIRTY flag in xfs (fllinden@amazon.com)
  + [8a16143b76d3] [2018-08-01] xfs: only validate summary counts on primary superblock (darrick.wong@oracle.com)
  + [53da7327aef0] [2018-07-26] libxfs: add more bounds checking to sb sanity checks (billodo@redhat.com)
  + [b8620cf39e63] [2018-07-29] xfs: refactor superblock verifiers (darrick.wong@oracle.com)
  + [11c9529697b3] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [95dc884b106f] [2018-10-04] ACPI/PPTT: Handle architecturally unknown cache types (jhugo@codeaurora.org)
  + [06ed53f674b1] [2018-06-05] ACPI / PPTT: fix build when CONFIG_ACPI_PPTT is not enabled (sudeep.holla@arm.com)
  + [9672719cb892] [2018-06-29] ACPI / PPTT: use ACPI ID whenever ACPI_PPTT_ACPI_PROCESSOR_ID_VALID is set (Sudeep.Holla@arm.com)
  + [4181ee338394] [2018-05-11] arm64: topology: divorce MC scheduling domain from core_siblings (jeremy.linton@arm.com)
  + [7058a745bde2] [2018-05-11] ACPI: Add PPTT to injectable table list (jeremy.linton@arm.com)
  + [531279f53dcc] [2018-05-11] arm64: topology: enable ACPI/PPTT based CPU topology (jeremy.linton@arm.com)
  + [7de75c9f1c20] [2018-05-11] arm64: topology: rename cluster_id (jeremy.linton@arm.com)
  + [9a900075a8e7] [2018-05-11] arm64: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [f0b1e1268098] [2018-05-11] drivers: base cacheinfo: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [742bf0423fdf] [2018-05-11] ACPI: Enable PPTT support on ARM64 (jeremy.linton@arm.com)
  + [426b79da729f] [2018-05-11] ACPI/PPTT: Add Processor Properties Topology Table parsing (jeremy.linton@arm.com)
  + [90d47fb2057d] [2018-05-11] arm64/acpi: Create arch specific cpu to acpi id helper (jeremy.linton@arm.com)
  + [b28517ae9e0d] [2018-05-11] cacheinfo: rename of_node to fw_token (jeremy.linton@arm.com)
  + [b8357af26766] [2018-05-11] drivers: base: cacheinfo: setup DT cache properties early (jeremy.linton@arm.com)
  + [8dd101b4b446] [2018-05-11] drivers: base: cacheinfo: move cache_setup_of_node() (jeremy.linton@arm.com)
  + [f1e50779ffa7] [2017-11-17] ACPICA: ACPI 6.2: Additional PPTT flags (jeremy.linton@arm.com)
  + [59bac9b9f27e] [2018-07-23] arm64: acpi: fix alignment fault in accessing ACPI (takahiro.akashi@linaro.org)
  + [9d5699c9a7ae] [2018-07-02] arm64: kexec: always reset to EL2 if present (mark.rutland@arm.com)
  + [61ed749f987d] [2018-03-08] efi/arm64: Check whether x18 is preserved by runtime services calls (ard.biesheuvel@linaro.org)
  + [82af66f45fe6] [2018-10-11] arm64: Fix /proc/iomem for reserved but not memory regions (will.deacon@arm.com)
  + [783724a40606] [2018-07-23] arm64: export memblock_reserve()d regions via /proc/iomem (james.morse@arm.com)
  + [96726844177d] [2018-11-10] net: ena: Import the ENA v2 driver (2.0.2g) (alakeshh@amazon.com)
  + [fd50db6aff77] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [7b4fce18fe4a] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [eb459bd387c4] [2018-10-29] ACPICA: Enable sleep button on ACPI legacy wake (anchalag@amazon.com)
  + [51b90a362edf] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [3c92f6cb3336] [2017-11-30] vmxnet3: increase default rx ring sizes (skhare@vmware.com)
  + [f81f3b03d3fc] [2018-04-27] x86/CPU/AMD: Derive CPU topology from CPUID function 0xB when available (suravee.suthikulpanit@amd.com)
  + [de495a9282d0] [2017-09-07] sched/topology: Introduce NUMA identity node sched domain (suravee.suthikulpanit@amd.com)
  + [bf4b5945dd02] [2018-06-13] x86/CPU/AMD: Fix LLC ID bit-shift calculation (suravee.suthikulpanit@amd.com)
  + [946b9e70b8c0] [2018-04-27] x86/CPU/AMD: Calculate last level cache ID from number of sharing threads (suravee.suthikulpanit@amd.com)
  + [7d7c72bfb77c] [2018-04-27] x86/CPU: Rename intel_cacheinfo.c to cacheinfo.c (bp@suse.de)
  + [953e246d85ac] [2018-05-17] x86/MCE/AMD: Read MCx_MISC block addresses on any CPU (bp@suse.de)
  + [85e099dc4697] [2018-08-15] blk-wbt: Avoid lock contention and thundering herd issue in wbt_wait (anchalag@amazon.com)
  + [42d5aee98119] [2018-01-12] blk-mq: simplify queue mapping & schedule with each possisble CPU (hch@lst.de)
  + [b413a6889bf6] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [6239056ae245] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [ccca846c8805] [2018-03-24] KVM: X86: Fix setup the virt_spin_lock_key before static key get initialized (wanpengli@tencent.com)
  + [97b78fd4d6b4] [2017-10-28] x86/paravirt: Set up the virt_spin_lock_key after static keys get initialized (douly.fnst@cn.fujitsu.com)
  + [4b8dfb4d07ba] [2018-02-13] KVM: X86: Choose qspinlock when dedicated physical CPUs are available (wanpengli@tencent.com)
  + [31d4c2427356] [2018-02-13] KVM: Introduce paravirtualization hints and KVM_HINTS_DEDICATED (wanpengli@tencent.com)
  + [8f53f901c3f1] [2017-09-06] locking/paravirt: Use new static key for controlling call of virt_spin_lock() (jgross@suse.com)
  + [7c4eed10c570] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [4fac3ed5393f] [2018-01-18] ACPI: SPCR: Make SPCR available to x86 (prarit@redhat.com)
  + [8b1dba731551] [2016-04-26] xen-blkfront: add 'persistent_grants' parameter (aliguori@amazon.com)
  + [82e13ce2e137] [2017-03-10] xen-blkfront: resurrect request-based mode (kamatam@amazon.com)
  + [606d2a4372d6] [2017-11-02] Not-for-upstream: PM / hibernate: Speed up hibernation by batching requests (cyberax@amazon.com)
  + [945e990dccd4] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [179ce130cae1] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [5d73987c53cf] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [458171517bbc] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [ac1065b34cf0] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [d7a202b9162b] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [ad1f2ab989ea] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [19f3ad338a19] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [d619d1ee29f3] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [297f23961038] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [80462862df6d] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [0ff2d5d8e881] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [9f3587729bcc] [2018-02-27] Importing Amazon ENA driver 1.5.0 into amazon-4.14.y/master. (vallish@amazon.com)
  + [d2fb8753ab7b] [2018-02-12] drivers/amazon: introduce AMAZON_ENA_ETHERNET (vallish@amazon.com)
  + [db82c8208dc8] [2018-02-12] drivers/amazon: add network device drivers support (vallish@amazon.com)
  + [056d952a3d17] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [22db2e7dd51a] [2017-10-27] not-for-upstream: testmgr config changes to enable FIPS boot (alakeshh@amazon.com)
  + [9cbe1ef254d1] [2017-09-19] nvme: update timeout module parameter type (vallish@amazon.com)
  + [622521f05215] [2015-12-08] force perf to use /usr/bin/python instead of /usr/bin/python2 (kamatam@amazon.com)
  + [0f662b8ca170] [2013-02-13] bump default tcp_wmem from 16KB to 20KB (gafton@amazon.com)
  + [71547af4a0a1] [2016-01-26] bump the default TTL to 255 (kamatam@amazon.com)
  + [0d649c0d2bd3] [2012-02-10] scsi: sd_revalidate_disk prevent NULL ptr deref (kernel-team@fedoraproject.org)
  + [d6fed8b13946] [2008-10-06] kbuild: AFTER_LINK (roland@redhat.com)

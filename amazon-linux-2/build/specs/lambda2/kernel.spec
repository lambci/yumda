...
+* Wed Apr 29 2020 Builder <builder@amazon.com>
- builder/81c631cd074376dc8afe1599ba1daeae887309fd last changes:
  + [81c631c] [2020-04-29] Rebase to v4.14.177 (linuxci@amazon.com)

- linux/c47975b1899e08467d6db52224e69864b9489ece last changes:
  + [c47975b] [2019-04-23] iommu/arm-smmu-v3: Don't disable SMMU in kdump kernel (will.deacon@arm.com)
  + [9e8a3b6] [2018-07-25] iommu/arm-smmu-v3: Abort all transactions if SMMU is enabled in kdump kernel (will.deacon@arm.com)
  + [9d0e847] [2018-07-12] iommu/arm-smmu-v3: Prevent any devices access to memory without registration (thunder.leizhen@huawei.com)
  + [a548e92] [2018-07-27] irqchip/gic-v3-its: Allow use of LPI tables in reserved memory (marc.zyngier@arm.com)
  + [e740201] [2018-07-27] irqchip/gic-v3-its: Register LPI tables with EFI config table (marc.zyngier@arm.com)
  + [4fe4296] [2018-07-27] irqchip/gic-v3-its: Check that all RDs have the same property table (marc.zyngier@arm.com)
  + [cc4f8b2] [2018-06-26] irqchip/gic-v3-its: Use pre-programmed redistributor tables with kdump kernels (marc.zyngier@arm.com)
  + [0cfa5ee] [2018-07-27] irqchip/gic-v3-its: Allow use of pre-programmed LPI tables (marc.zyngier@arm.com)
  + [1d807efc] [2018-07-27] irqchip/gic-v3-its: Keep track of property table's PA and VA (marc.zyngier@arm.com)
  + [763b986] [2018-07-27] irqchip/gic-v3-its: Move pending table allocation to init time (marc.zyngier@arm.com)
  + [ac8adae] [2018-07-27] irqchip/gic-v3-its: Split property table clearing from allocation (marc.zyngier@arm.com)
  + [29f1ac3] [2018-07-17] irqchip/gic-v3-its: Simplify LPI_PENDBASE_SZ usage (marc.zyngier@arm.com)
  + [1e0bd53] [2018-07-27] irqchip/gic-v3-its: Change initialization ordering for LPIs (marc.zyngier@arm.com)
  + [d49d477] [2018-03-21] irqchip/gic-v3: Ensure GICR_CTLR.EnableLPI=0 is observed before enabling (shankerd@codeaurora.org)
  + [0ce3f53] [2019-12-06] efi/memreserve: Register reservations as 'reserved' in /proc/iomem (ardb@kernel.org)
  + [b407112] [2019-06-09] efi/memreserve: deal with memreserve entries in unmapped memory (ard.biesheuvel@linaro.org)
  + [08fbeba] [2018-11-29] efi: Reduce the amount of memblock reservations for persistent allocations (ard.biesheuvel@linaro.org)
  + [44aa071] [2018-11-29] efi: Permit multiple entries in persistent memreserve data structure (ard.biesheuvel@linaro.org)
  + [5ea22b4] [2018-11-23] efi: Prevent GICv3 WARN() by mapping the memreserve table before first use (ard.biesheuvel@linaro.org)
  + [2c08061] [2018-11-14] efi: Permit calling efi_mem_reserve_persistent() from atomic context (ard.biesheuvel@linaro.org)
  + [1b8d0b2] [2018-09-21] efi: add API to reserve memory persistently across kexec reboot (ard.biesheuvel@linaro.org)
  + [80c2b08] [2018-09-21] efi/arm: libstub: add a root memreserve config table (ard.biesheuvel@linaro.org)
  + [78f0e1e] [2018-09-21] efi: honour memory reservations passed via a linux specific config table (ard.biesheuvel@linaro.org)
  + [e7621c5] [2020-04-07] kernel/sched/fair.c: Fix divide by zero (sblbir@amazon.com)
  + [69f7c0a9] [2020-04-01] Revert "ena: update to 2.2.3" (yishache@amazon.com)
  + [eaf63b7] [2020-03-08] lustre: update to AmazonFSxLustreClient v2.10.8-1 (astroh@amazon.com)
  + [e2d7095] [2020-01-29] random: introduce RANDOM_WAIT_JITTER config option (fllinden@amazon.com)
  + [f974851] [2019-09-28] random: try to actively add entropy rather than passively wait for it (torvalds@linux-foundation.org)
  + [3666d7c8] [2020-02-26] ena: update to 2.2.3 (fllinden@amazon.com)
  + [7fe1682] [2019-06-26] perf: arm_spe: Enable ACPI/Platform automatic module loading (jeremy.linton@arm.com)
  + [13568d1] [2019-06-26] arm_pmu: acpi: spe: Add initial MADT/SPE probing (jeremy.linton@arm.com)
  + [d1128b6] [2019-06-26] ACPI/PPTT: Add function to return ACPI 6.3 Identical tokens (jeremy.linton@arm.com)
  + [00edf83] [2019-06-26] ACPI/PPTT: Modify node flag detection to find last IDENTICAL (jeremy.linton@arm.com)
  + [147c01d] [2020-01-29] ACPICA: ACPI 6.3: PPTT add additional fields in Processor Structure Flags (erik.schmauss@intel.com)
  + [3bbbc91] [2020-01-28] ACPICA: ACPI 6.3: MADT: add support for statistical profiling in GICC (erik.schmauss@intel.com)
  + [4ebf6c7] [2018-08-10] perf arm spe: Fix uninitialized record error variable (kim.phillips@arm.com)
  + [0c9ef22] [2018-01-14] perf tools: Add ARM Statistical Profiling Extensions (SPE) support (kim.phillips@arm.com)
  + [c4ccb64] [2016-09-22] drivers/perf: Add support for ARMv8.2 Statistical Profiling Extension (will.deacon@arm.com)
  + [a8933aa] [2016-09-22] dt-bindings: Document devicetree binding for ARM SPE (will.deacon@arm.com)
  + [faa7def] [2017-07-07] arm64: head: Init PMSCR_EL2.{PA,PCT} when entered at EL2 without VHE (will.deacon@arm.com)
  + [7ac6edb] [2017-09-20] arm64: sysreg: Move SPE registers and PSB into common header files (will.deacon@arm.com)
  + [0da0850] [2016-09-23] perf/core: Add PERF_AUX_FLAG_COLLISION to report colliding samples (will.deacon@arm.com)
  + [9adad06] [2016-08-16] perf/core: Export AUX buffer helpers to modules (will.deacon@arm.com)
  + [e20fca3] [2016-07-25] genirq: export irq_get_percpu_devid_partition to modules (will.deacon@arm.com)
  + [d899768] [2018-03-29] Don't log confusing message on reconnect by default (stfrench@microsoft.com)
  + [be3cf39] [2018-03-21] Don't log expected error on DFS referral request (smfrench@gmail.com)
  + [803f147] [2017-11-21] CIFS: don't log STATUS_NOT_FOUND errors for DFS (aaptel@suse.com)
  + [c1d1122] [2018-07-05] cifs: Fix slab-out-of-bounds in send_set_info() on SMB2 ACE setting (sbrivio@redhat.com)
  + [250f452] [2019-12-31] lib/list-test: add a test for the 'list' doubly linked list (davidgow@google.com)
  + [b356260] [2019-09-08] Documentation: kunit: Fix verification command (sj38.park@gmail.com)
  + [74d8287] [2019-09-23] Documentation: kunit: add documentation for KUnit (brendanhiggins@google.com)
  + [840866a] [2019-09-07] kunit: Fix '--build_dir' option (sj38.park@gmail.com)
  + [b04b940] [2019-09-23] kunit: defconfig: add defconfigs for building KUnit tests (brendanhiggins@google.com)
  + [29ef98b] [2019-09-23] kunit: tool: add Python wrappers for running KUnit tests (felixguoxiuping@gmail.com)
  + [7a4fb6d] [2019-09-23] kunit: fix failure to build without printk (brendanhiggins@google.com)
  + [a873358] [2019-09-23] kunit: test: add tests for KUnit managed resources (akndr41@gmail.com)
  + [245f41a] [2019-09-23] kunit: test: add the concept of assertions (brendanhiggins@google.com)
  + [0729c1c] [2019-09-23] kunit: test: add tests for kunit test abort (brendanhiggins@google.com)
  + [e351ca6] [2019-09-23] kunit: test: add support for test abort (brendanhiggins@google.com)
  + [28f3743] [2019-09-23] kunit: test: add initial tests (brendanhiggins@google.com)
  + [606f150] [2019-12-31] lib: enable building KUnit in lib/ (brendanhiggins@google.com)
  + [d6ce552] [2019-09-23] kunit: test: add the concept of expectations (brendanhiggins@google.com)
  + [fe5f8bc3] [2019-09-23] kunit: test: add assertion printing library (brendanhiggins@google.com)
  + [6bc0673] [2019-09-23] kunit: test: add string_stream a std::stream like string builder (brendanhiggins@google.com)
  + [b933334] [2019-09-23] kunit: test: add test resource management API (brendanhiggins@google.com)
  + [a4b7c3b] [2019-09-23] kunit: test: add KUnit test runner core (brendanhiggins@google.com)
  + [f4d5936] [2020-02-03] Revert "update ENA linux driver to version 2.2.1" (anchalag@amazon.com)
  + [9cca3de] [2020-01-20] update ENA linux driver to version 2.2.1 (anchalag@amazon.com)
  + [20f51d9] [2019-12-18] Add support for setting owner info, dos attributes, and create time (bprotopopov@hotmail.com)
  + [3208297] [2018-08-28] SMB3: Backup intent flag missing from compounded ops (stfrench@microsoft.com)
  + [ad11260] [2019-12-19] drivers/amazon: efa: update to 1.5.0 (luqia@amazon.com)
  + [4eac88f4] [2019-12-16] Revert "Fix the locking in dcache_readdir() and friends". (fllinden@amazon.com)
  + [75611ee] [2019-12-04] lustre: hold lock while walking changelog dev list (astroh@amazon.com)
  + [f8a9e81] [2019-11-15] arm64: fix merge error in errata changes (fllinden@amazon.com)
  + [894d927] [2019-11-12] nvme-pci: use atomic bitops to mark a queue enabled (hch@lst.de)
  + [a390d1b] [2019-11-11] nvme-pci: Don't disable on timeout in reset state (keith.busch@intel.com)
  + [ca0c162] [2019-11-11] nvme-pci: Unblock reset_work on IO failure (keith.busch@intel.com)
  + [e826816] [2019-11-11] nvme-pci: shutdown on timeout during deletion (keith.busch@intel.com)
  + [a8da15b] [2018-02-08] nvme-pci: Fix timeouts in connecting state (keith.busch@intel.com)
  + [9025a50] [2019-11-11] nvme: rename NVME_CTRL_RECONNECTING state to NVME_CTRL_CONNECTING (maxg@mellanox.com)
  + [8dae9bd] [2017-10-25] nvme: allow controller RESETTING to RECONNECTING transition (jsmart2021@gmail.com)
  + [a098836] [2019-11-11] nvme-pci: introduce RECONNECTING state to mark initializing procedure (jianchao.w.wang@oracle.com)
  + [b1f4ebb] [2019-11-11] Revert "nvme/pci: Better support for disabling controller" (sblbir@amazon.com)
  + [860c352] [2019-11-04] update ena driver to version 2.1.3 (alakeshh@amazon.com)
  + [3a7a6be] [2018-06-22] arm64: Avoid flush_icache_range() in alternatives patching code (will.deacon@arm.com)
  + [99c15fc] [2018-09-27] arm64: pull in upstream erratum workarounds (fllinden@amazon.com)
  + [aa1591b] [2018-03-13] arm64: kconfig: Ensure spinlock fastpaths are inlined if !PREEMPT (will.deacon@arm.com)
  + [4e7caa3] [2018-03-13] arm64: locking: Replace ticket lock implementation with qspinlock (will.deacon@arm.com)
  + [9813f06] [2018-01-31] arm64: barrier: Implement smp_cond_load_relaxed (will.deacon@arm.com)
  + [08f468e] [2018-04-26] MAINTAINERS: Add myself as a co-maintainer for the locking subsystem (will.deacon@arm.com)
  + [4530c57] [2018-04-26] locking/qspinlock: Use try_cmpxchg() instead of cmpxchg() when locking (will.deacon@arm.com)
  + [c64aada] [2018-04-26] locking/qspinlock: Elide back-to-back RELEASE operations with smp_wmb() (will.deacon@arm.com)
  + [666f400] [2018-04-26] locking/qspinlock: Use smp_store_release() in queued_spin_unlock() (will.deacon@arm.com)
  + [904ab3f] [2018-04-26] locking/qspinlock: Use smp_cond_load_relaxed() to wait for next node (will.deacon@arm.com)
  + [f476157] [2018-04-26] locking/mcs: Use smp_cond_load_acquire() in MCS spin loop (jason.low2@hp.com)
  + [c91f027] [2018-04-26] locking/qspinlock: Use atomic_cond_read_acquire() (will.deacon@arm.com)
  + [3a97c21] [2018-04-26] locking/barriers: Introduce smp_cond_load_relaxed() and atomic_cond_read_relaxed() (will.deacon@arm.com)
  + [79de161] [2017-10-12] locking/atomic: Add atomic_cond_read_acquire() (will.deacon@arm.com)
  + [754febc4] [2019-08-29] iommu: use config option to specify if iommu mode should be strict (fllinden@amazon.com)
  + [3d4b4d9] [2018-09-20] iommu/arm-smmu: Support non-strict mode (robin.murphy@arm.com)
  + [de8fb22] [2018-09-20] iommu/io-pgtable-arm-v7s: Add support for non-strict mode (robin.murphy@arm.com)
  + [277dde0] [2018-09-20] iommu/arm-smmu-v3: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [df249e1] [2018-09-20] iommu/io-pgtable-arm: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [b2af902] [2018-09-20] iommu: Add "iommu.strict" command line option (thunder.leizhen@huawei.com)
  + [4ce9717] [2018-09-20] iommu/dma: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [362e7fb] [2018-09-20] iommu/arm-smmu-v3: Implement flush_iotlb_all hook (thunder.leizhen@huawei.com)
  + [34891cd] [2017-09-28] iommu/io-pgtable-arm-v7s: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [da24125] [2017-09-28] iommu/io-pgtable-arm: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [2bff80e] [2019-03-12] irqchip/gic-v3-its: Fix comparison logic in lpi_range_cmp (linux@rasmusvillemoes.dk)
  + [f87708c] [2019-01-29] irqchip/gic-v3-its: Gracefully fail on LPI exhaustion (marc.zyngier@arm.com)
  + [501104a] [2018-08-28] irqchip/gic-v3-its: Cap lpi_id_bits to reduce memory footprint (jia.he@hxt-semitech.com)
  + [c66ce9e] [2018-05-31] irqchip/gic-v3-its: Reduce minimum LPI allocation to 1 for PCI devices (marc.zyngier@arm.com)
  + [d9a3561] [2018-05-31] irqchip/gic-v3-its: Honor hypervisor enforced LPI range (marc.zyngier@arm.com)
  + [d4264db] [2018-05-30] irqchip/gic-v3: Expose GICD_TYPER in the rdist structure (marc.zyngier@arm.com)
  + [3f16c6e] [2018-05-27] irqchip/gic-v3-its: Drop chunk allocation compatibility (marc.zyngier@arm.com)
  + [97bea07] [2018-05-27] irqchip/gic-v3-its: Move minimum LPI requirements to individual busses (marc.zyngier@arm.com)
  + [d47b333] [2018-05-27] irqchip/gic-v3-its: Use full range of LPIs (marc.zyngier@arm.com)
  + [fb14610] [2018-05-27] irqchip/gic-v3-its: Refactor LPI allocator (marc.zyngier@arm.com)
  + [e394005] [2018-06-22] irqchip/gic-v3-its: Only emit VSYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [1f4e907] [2018-06-22] irqchip/gic-v3-its: Only emit SYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [0357315] [2017-07-28] irqchip/gic-v3-its: Pass its_node pointer to each command builder (marc.zyngier@arm.com)
  + [aad021f] [2018-05-17] nvme-pci: move ->cq_vector == -1 check outside of ->q_lock (axboe@kernel.dk)
  + [894a81a] [2019-09-13] nvme/host/pci: Fix a race in controller removal (sblbir@amzn.com)
  + [40bf417] [2019-09-13] nvme/host/core: Allow overriding of wait_ready timeout (sblbir@amzn.com)
  + [668893c] [2019-09-10] nvme/pci: Better support for disabling controller (sblbir@amzn.com)
  + [f92d31c] [2017-11-02] nvme: move the dying queue check from cancel to completion (hch@lst.de)
  + [c74f142] [2019-08-28] blk-mq: fix hang caused by freeze/unfreeze sequence (bob.liu@oracle.com)
  + [ccfbf0d] [2019-08-16] nvme: change namespaces_mutext to namespaces_rwsem (jianchao.w.wang@oracle.com)
  + [7e9073d] [2018-09-26] block: Allow unfreezing of a queue while requests are in progress (bvanassche@acm.org)
  + [036faee] [2019-08-16] percpu-refcount: Introduce percpu_ref_resurrect() (bvanassche@acm.org)
  + [fe350fc] [2019-09-05] Add Amazon EFA driver version 1.4 (alakeshh@amazon.com)
  + [448ea6f] [2019-04-02] block: don't show io_timeout if driver has no timeout handler (zhangweiping@didiglobal.com)
  + [f0c0ffa] [2018-11-29] block: add io timeout to sysfs (zhangweiping@didiglobal.com)
  + [498ff52] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [017d9cf] [2019-01-09] livepatch: Change unsigned long old_addr -> void *old_func in struct klp_func (pmladek@suse.com)
  + [012181d] [2018-11-07] livepatch: Replace synchronize_sched() with synchronize_rcu() (paulmck@linux.ibm.com)
  + [31faa8b] [2018-07-12] livepatch: Remove reliable stacktrace check in klp_try_switch_task() (kamalesh@linux.vnet.ibm.com)
  + [bd36b3a] [2018-04-16] livepatch: Allow to call a custom callback when freeing shadow variables (pmladek@suse.com)
  + [390c57a] [2018-04-16] livepatch: Initialize shadow variables safely by a custom callback (pmladek@suse.com)
  + [fa015c2] [2017-12-21] livepatch: add locking to force and signal functions (mbenes@suse.cz)
  + [6d78185] [2018-01-10] livepatch: Remove immediate feature (mbenes@suse.cz)
  + [266bee7] [2017-11-22] livepatch: force transition to finish (mbenes@suse.cz)
  + [e4ec155] [2017-11-15] livepatch: send a fake signal to all blocking tasks (mbenes@suse.cz)
  + [7e7b448d] [2017-10-20] livepatch: __klp_disable_patch() should never be called for disabled patches (pmladek@suse.com)
  + [532d01c] [2017-10-20] livepatch: Correctly call klp_post_unpatch_callback() in error paths (pmladek@suse.com)
  + [90e6262] [2017-10-13] livepatch: add transition notices (joe.lawrence@redhat.com)
  + [0563dfb] [2017-10-13] livepatch: move transition "complete" notice into klp_complete_transition() (joe.lawrence@redhat.com)
  + [dcbaf65] [2017-10-13] livepatch: add (un)patch callbacks (joe.lawrence@redhat.com)
  + [65770f6] [2017-09-14] livepatch: __klp_shadow_get_or_alloc() is local to shadow.c (jkosina@suse.cz)
  + [8233ca6] [2017-08-31] livepatch: introduce shadow variable API (joe.lawrence@redhat.com)
  + [ed912f1] [2019-08-15] Partially revert cc946adcb9e983ad9fe56ebe35f1292e111ff10e (sblbir@amzn.com)
  + [1e74860] [2019-07-11] PCI: Add ACS quirk for Amazon Annapurna Labs root ports (alisaidi@amazon.com)
  + [6ff17f8] [2019-07-11] PCI: Add Amazon's Annapurna Labs vendor ID (jonnyc@amazon.com)
  + [2d806be] [2019-06-24] linux/ena: update ENA linux driver to version 2.1.1 (fllinden@amazon.com)
  + [47ecd15] [2019-07-02] microvm: enable debug in case of tcp out of memory (alakeshh@amazon.com)
  + [af79e27] [2019-07-03] Fix microvm config dependency in Kconfig (alakeshh@amazon.com)
  + [4334549] [2019-02-12] NFS: Remove redundant semicolon (zhangliguang@linux.alibaba.com)
  + [d2e5a60] [2019-05-31] arm64: acpi/pci: invoke _DSM whether to preserve firmware PCI setup (fllinden@amazon.com)
  + [2518c98] [2019-03-28] PCI: al: Add Amazon Annapurna Labs PCIe host controller driver (jonnyc@amazon.com)
  + [323a273] [2019-04-24] irqchip/gic-v2m: invoke from gic-v3 initialization and add acpi quirk flow (zeev@amazon.com)
  + [011330e] [2019-04-03] lustre: fix ACL handling (fllinden@amazon.com)
  + [d8b3924] [2018-05-18] x86/stacktrace: Enable HAVE_RELIABLE_STACKTRACE for the ORC unwinder (jslaby@suse.cz)
  + [bfa32b9] [2018-05-18] x86/unwind/orc: Detect the end of the stack (jpoimboe@redhat.com)
  + [dabf822] [2018-05-18] x86/stacktrace: Do not fail for ORC with regs on stack (jslaby@suse.cz)
  + [6d13fbb] [2018-05-18] x86/stacktrace: Clarify the reliable success paths (jslaby@suse.cz)
  + [0f4a1b1] [2018-05-18] x86/stacktrace: Remove STACKTRACE_DUMP_ONCE (jslaby@suse.cz)
  + [912b21c] [2018-05-18] x86/stacktrace: Do not unwind after user regs (jslaby@suse.cz)
  + [781c96e] [2019-03-12] Add new config CONFIG_MICROVM to enable microvm optimized kernel (alakeshh@amazon.com)
  + [e2fce29] [2019-02-19] tcp: Namespace-ify sysctl_tcp_rmem and sysctl_tcp_wmem (edumazet@google.com)
  + [f3d7505] [2017-11-07] net: allow per netns sysctl_rmem and sysctl_wmem for protos (edumazet@google.com)
  + [f53b7f9] [2019-03-01] Config glue for lustre client. (fllinden@amazon.com)
  + [2cd1fd0] [2019-03-01] Import lustre client 2.10.5 (fllinden@amazon.com)
  + [b9274ef] [2018-06-05] iomap: fsync swap files before iterating mappings (darrick.wong@oracle.com)
  + [957a04e] [2018-06-01] iomap: inline data should be an iomap type, not a flag (hch@lst.de)
  + [cc330aa] [2018-05-16] iomap: don't allow holes in swapfiles (osandov@fb.com)
  + [36b77df] [2018-05-16] iomap: provide more useful errors for invalid swap files (osandov@fb.com)
  + [f2a32b5] [2018-05-10] iomap: add a swapfile activation function (darrick.wong@oracle.com)
  + [1c4bf7f] [2019-01-30] xfs, iomap: define and use the IOMAP_F_DIRTY flag in xfs (fllinden@amazon.com)
  + [91259c8] [2018-08-01] xfs: only validate summary counts on primary superblock (darrick.wong@oracle.com)
  + [fc293c0] [2018-07-26] libxfs: add more bounds checking to sb sanity checks (billodo@redhat.com)
  + [9d68907] [2018-07-29] xfs: refactor superblock verifiers (darrick.wong@oracle.com)
  + [60d145a] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [587861b] [2018-10-04] ACPI/PPTT: Handle architecturally unknown cache types (jhugo@codeaurora.org)
  + [eb4d34f] [2018-06-05] ACPI / PPTT: fix build when CONFIG_ACPI_PPTT is not enabled (sudeep.holla@arm.com)
  + [4a23491] [2018-06-29] ACPI / PPTT: use ACPI ID whenever ACPI_PPTT_ACPI_PROCESSOR_ID_VALID is set (Sudeep.Holla@arm.com)
  + [d738a00] [2018-05-11] arm64: topology: divorce MC scheduling domain from core_siblings (jeremy.linton@arm.com)
  + [d9fd4ff] [2018-05-11] ACPI: Add PPTT to injectable table list (jeremy.linton@arm.com)
  + [72c7f10] [2018-05-11] arm64: topology: enable ACPI/PPTT based CPU topology (jeremy.linton@arm.com)
  + [4ac5ff7] [2018-05-11] arm64: topology: rename cluster_id (jeremy.linton@arm.com)
  + [cd5355b] [2018-05-11] arm64: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [19a23c6] [2018-05-11] drivers: base cacheinfo: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [d2642f3] [2018-05-11] ACPI: Enable PPTT support on ARM64 (jeremy.linton@arm.com)
  + [418adad] [2018-05-11] ACPI/PPTT: Add Processor Properties Topology Table parsing (jeremy.linton@arm.com)
  + [727f578] [2018-05-11] arm64/acpi: Create arch specific cpu to acpi id helper (jeremy.linton@arm.com)
  + [1fc061e] [2018-05-11] cacheinfo: rename of_node to fw_token (jeremy.linton@arm.com)
  + [ddc786a] [2018-05-11] drivers: base: cacheinfo: setup DT cache properties early (jeremy.linton@arm.com)
  + [3697328] [2018-05-11] drivers: base: cacheinfo: move cache_setup_of_node() (jeremy.linton@arm.com)
  + [3f49f87] [2017-11-17] ACPICA: ACPI 6.2: Additional PPTT flags (jeremy.linton@arm.com)
  + [a3c0847] [2018-07-23] arm64: acpi: fix alignment fault in accessing ACPI (takahiro.akashi@linaro.org)
  + [9b11fbb] [2018-07-02] arm64: kexec: always reset to EL2 if present (mark.rutland@arm.com)
  + [0219dca] [2018-03-08] efi/arm64: Check whether x18 is preserved by runtime services calls (ard.biesheuvel@linaro.org)
  + [55db5df] [2018-10-11] arm64: Fix /proc/iomem for reserved but not memory regions (will.deacon@arm.com)
  + [078e390] [2018-07-23] arm64: export memblock_reserve()d regions via /proc/iomem (james.morse@arm.com)
  + [8ad5af2] [2018-11-10] net: ena: Import the ENA v2 driver (2.0.2g) (alakeshh@amazon.com)
  + [3e47cee] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [2b3b0c2] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [5a062e3] [2018-10-29] ACPICA: Enable sleep button on ACPI legacy wake (anchalag@amazon.com)
  + [4877b87] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [6a148b6] [2017-11-30] vmxnet3: increase default rx ring sizes (skhare@vmware.com)
  + [0465cd0] [2018-04-27] x86/CPU/AMD: Derive CPU topology from CPUID function 0xB when available (suravee.suthikulpanit@amd.com)
  + [2a205db] [2017-09-07] sched/topology: Introduce NUMA identity node sched domain (suravee.suthikulpanit@amd.com)
  + [66b6d08] [2018-06-13] x86/CPU/AMD: Fix LLC ID bit-shift calculation (suravee.suthikulpanit@amd.com)
  + [04fcb9d] [2018-04-27] x86/CPU/AMD: Calculate last level cache ID from number of sharing threads (suravee.suthikulpanit@amd.com)
  + [3cb818c] [2018-04-27] x86/CPU: Rename intel_cacheinfo.c to cacheinfo.c (bp@suse.de)
  + [963bbd0] [2018-05-17] x86/MCE/AMD: Read MCx_MISC block addresses on any CPU (bp@suse.de)
  + [4dd576f] [2018-08-15] blk-wbt: Avoid lock contention and thundering herd issue in wbt_wait (anchalag@amazon.com)
  + [4c548b6] [2018-01-12] blk-mq: simplify queue mapping & schedule with each possisble CPU (hch@lst.de)
  + [b1f5906] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [daa12ce] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [ef7b841] [2018-03-24] KVM: X86: Fix setup the virt_spin_lock_key before static key get initialized (wanpengli@tencent.com)
  + [3058c45] [2017-10-28] x86/paravirt: Set up the virt_spin_lock_key after static keys get initialized (douly.fnst@cn.fujitsu.com)
  + [d056028] [2018-02-13] KVM: X86: Choose qspinlock when dedicated physical CPUs are available (wanpengli@tencent.com)
  + [29667b1] [2018-02-13] KVM: Introduce paravirtualization hints and KVM_HINTS_DEDICATED (wanpengli@tencent.com)
  + [6a266d4] [2017-09-06] locking/paravirt: Use new static key for controlling call of virt_spin_lock() (jgross@suse.com)
  + [aae9384] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [abf0462] [2018-01-18] ACPI: SPCR: Make SPCR available to x86 (prarit@redhat.com)
  + [d5a2c07] [2016-04-26] xen-blkfront: add 'persistent_grants' parameter (aliguori@amazon.com)
  + [53bd896] [2017-03-10] xen-blkfront: resurrect request-based mode (kamatam@amazon.com)
  + [de2948b] [2017-11-02] Not-for-upstream: PM / hibernate: Speed up hibernation by batching requests (cyberax@amazon.com)
  + [f136185] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [2846b1c] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [3219938] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [e3d0f00] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [66f2eac] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [c37cf03] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [22f449e] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [abeb9a9] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [b125da9] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [89d1320] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [2845a70] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [9728dbe] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [e30de38] [2018-02-27] Importing Amazon ENA driver 1.5.0 into amazon-4.14.y/master. (vallish@amazon.com)
  + [f9281f5] [2018-02-12] drivers/amazon: introduce AMAZON_ENA_ETHERNET (vallish@amazon.com)
  + [19d9cb9] [2018-02-12] drivers/amazon: add network device drivers support (vallish@amazon.com)
  + [578910f] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [bd058a5] [2017-10-27] not-for-upstream: testmgr config changes to enable FIPS boot (alakeshh@amazon.com)
  + [c39b8ef] [2017-09-19] nvme: update timeout module parameter type (vallish@amazon.com)
  + [73a6943] [2015-12-08] force perf to use /usr/bin/python instead of /usr/bin/python2 (kamatam@amazon.com)
  + [a8e5cfc] [2013-02-13] bump default tcp_wmem from 16KB to 20KB (gafton@amazon.com)
  + [9bdef7f] [2016-01-26] bump the default TTL to 255 (kamatam@amazon.com)
  + [e02bdc3] [2012-02-10] scsi: sd_revalidate_disk prevent NULL ptr deref (kernel-team@fedoraproject.org)
  + [caf4c4c] [2008-10-06] kbuild: AFTER_LINK (roland@redhat.com)

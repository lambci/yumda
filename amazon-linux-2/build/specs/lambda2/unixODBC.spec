...
%exclude %{_mandir}
%exclude %{_includedir}
%exclude %{_libdir}/libesoobS.so
%exclude %{_libdir}/libmimerS.so
%exclude %{_libdir}/libnn.so
%exclude %{_libdir}/libodbccr.so
%exclude %{_libdir}/libodbcdrvcfg1S.so
%exclude %{_libdir}/libodbcdrvcfg2S.so
%exclude %{_libdir}/libodbcminiS.so
%exclude %{_libdir}/libodbcnnS.so
%exclude %{_libdir}/libodbctxtS.so
%exclude %{_libdir}/liboplodbcS.so
%exclude %{_libdir}/liboraodbcS.so
%exclude %{_libdir}/libsapdbS.so
%exclude %{_libdir}/libtdsS.so
%exclude %{_libdir}/libtemplate.so

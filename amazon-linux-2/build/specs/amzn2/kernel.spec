...
Patch0257: 0257-NFSv4.1-fix-incorrect-return-value-in-copy_file_rang.patch
Patch0258: 0258-lustre-restore-mgc-binding-for-sptlrpc.patch
Patch0259: 0259-Update-lustrefsx-to-v2.10.8-5.patch
...
ApplyPatch 0257-NFSv4.1-fix-incorrect-return-value-in-copy_file_rang.patch
ApplyPatch 0258-lustre-restore-mgc-binding-for-sptlrpc.patch
ApplyPatch 0259-Update-lustrefsx-to-v2.10.8-5.patch
...
%changelog
* Wed Jun 24 2020 Builder <builder@amazon.com>
- builder/4b00bcbcfb10b0e9bae5ffb0d4d0c8700326faba last changes:

- linux/4e2d8a9dc1bf42817e247f16b9cf070efa0f2c83 last changes:
  + [4e2d8a9dc1bf] [2020-06-18] Update lustrefsx to v2.10.8-5 (astroh@amazon.com)
  + [00f56b8ab37f] [2020-05-27] lustre: restore mgc binding for sptlrpc (astroh@amazon.com)
  + [c53a2fb00c2a] [2019-04-11] NFSv4.1 fix incorrect return value in copy_file_range (kolga@netapp.com)
  + [e25effdeb802] [2020-05-27] Fix a build issue caused by 45b2013293a2a (sblbir@amazon.com)
  + [1494a4a3477e] [2020-05-22] x86/unwind/orc: Fix unwind_get_return_address_ptr() for inactive tasks (jpoimboe@redhat.com)
  + [b438c87d76c0] [2020-05-26] Upgrade to ena 2.2.8 (sblbir@amazon.com)
  + [4f05ace422cf] [2020-04-13] xen-blkfront: Delay flush till queue lock dropped (samjonas@amazon.com)
  + [0a4bc7ff9ae3] [2019-04-23] iommu/arm-smmu-v3: Don't disable SMMU in kdump kernel (will.deacon@arm.com)
  + [fa76fa030a01] [2018-07-25] iommu/arm-smmu-v3: Abort all transactions if SMMU is enabled in kdump kernel (will.deacon@arm.com)
  + [bd9ff62b1ef9] [2018-07-12] iommu/arm-smmu-v3: Prevent any devices access to memory without registration (thunder.leizhen@huawei.com)
  + [85aea643a0a5] [2018-07-27] irqchip/gic-v3-its: Allow use of LPI tables in reserved memory (marc.zyngier@arm.com)
  + [f8966ea3662f] [2018-07-27] irqchip/gic-v3-its: Register LPI tables with EFI config table (marc.zyngier@arm.com)
  + [425643d8b6de] [2018-07-27] irqchip/gic-v3-its: Check that all RDs have the same property table (marc.zyngier@arm.com)
  + [8dec677262b8] [2018-06-26] irqchip/gic-v3-its: Use pre-programmed redistributor tables with kdump kernels (marc.zyngier@arm.com)
  + [f1f036691895] [2018-07-27] irqchip/gic-v3-its: Allow use of pre-programmed LPI tables (marc.zyngier@arm.com)
  + [36497aea3827] [2018-07-27] irqchip/gic-v3-its: Keep track of property table's PA and VA (marc.zyngier@arm.com)
  + [645521ff13f0] [2018-07-27] irqchip/gic-v3-its: Move pending table allocation to init time (marc.zyngier@arm.com)
  + [dd3d10481f44] [2018-07-27] irqchip/gic-v3-its: Split property table clearing from allocation (marc.zyngier@arm.com)
  + [995d17f0dd08] [2018-07-17] irqchip/gic-v3-its: Simplify LPI_PENDBASE_SZ usage (marc.zyngier@arm.com)
  + [9c41373c2044] [2018-07-27] irqchip/gic-v3-its: Change initialization ordering for LPIs (marc.zyngier@arm.com)
  + [7ff1e6f41f13] [2018-03-21] irqchip/gic-v3: Ensure GICR_CTLR.EnableLPI=0 is observed before enabling (shankerd@codeaurora.org)
  + [abe3e5d808ad] [2019-12-06] efi/memreserve: Register reservations as 'reserved' in /proc/iomem (ardb@kernel.org)
  + [78e08082d520] [2019-06-09] efi/memreserve: deal with memreserve entries in unmapped memory (ard.biesheuvel@linaro.org)
  + [521f825cf300] [2018-11-29] efi: Reduce the amount of memblock reservations for persistent allocations (ard.biesheuvel@linaro.org)
  + [605d1331f05b] [2018-11-29] efi: Permit multiple entries in persistent memreserve data structure (ard.biesheuvel@linaro.org)
  + [a7fad6549115] [2018-11-23] efi: Prevent GICv3 WARN() by mapping the memreserve table before first use (ard.biesheuvel@linaro.org)
  + [79a33a08359b] [2018-11-14] efi: Permit calling efi_mem_reserve_persistent() from atomic context (ard.biesheuvel@linaro.org)
  + [eda461115864] [2018-09-21] efi: add API to reserve memory persistently across kexec reboot (ard.biesheuvel@linaro.org)
  + [c564d2b8429c] [2018-09-21] efi/arm: libstub: add a root memreserve config table (ard.biesheuvel@linaro.org)
  + [7a17d7ae5bb6] [2018-09-21] efi: honour memory reservations passed via a linux specific config table (ard.biesheuvel@linaro.org)
  + [967d0ccd4d4a] [2020-04-07] kernel/sched/fair.c: Fix divide by zero (sblbir@amazon.com)
  + [cf74b7b2d9e8] [2020-04-01] Revert "ena: update to 2.2.3" (yishache@amazon.com)
  + [984e344ec980] [2020-03-08] lustre: update to AmazonFSxLustreClient v2.10.8-1 (astroh@amazon.com)
  + [62b938566807] [2020-01-29] random: introduce RANDOM_WAIT_JITTER config option (fllinden@amazon.com)
  + [f8d40ed2b72e] [2019-09-28] random: try to actively add entropy rather than passively wait for it (torvalds@linux-foundation.org)
  + [1b0953f53609] [2020-02-26] ena: update to 2.2.3 (fllinden@amazon.com)
  + [3129ff05c99a] [2019-06-26] perf: arm_spe: Enable ACPI/Platform automatic module loading (jeremy.linton@arm.com)
  + [d50255a277e6] [2019-06-26] arm_pmu: acpi: spe: Add initial MADT/SPE probing (jeremy.linton@arm.com)
  + [d3891d427fe9] [2019-06-26] ACPI/PPTT: Add function to return ACPI 6.3 Identical tokens (jeremy.linton@arm.com)
  + [070f4d2fd281] [2019-06-26] ACPI/PPTT: Modify node flag detection to find last IDENTICAL (jeremy.linton@arm.com)
  + [9fe0525a7689] [2020-01-29] ACPICA: ACPI 6.3: PPTT add additional fields in Processor Structure Flags (erik.schmauss@intel.com)
  + [953c4d035d1c] [2020-01-28] ACPICA: ACPI 6.3: MADT: add support for statistical profiling in GICC (erik.schmauss@intel.com)
  + [850242b451bc] [2018-08-10] perf arm spe: Fix uninitialized record error variable (kim.phillips@arm.com)
  + [1936c022f67e] [2018-01-14] perf tools: Add ARM Statistical Profiling Extensions (SPE) support (kim.phillips@arm.com)
  + [590a8c172fcf] [2016-09-22] drivers/perf: Add support for ARMv8.2 Statistical Profiling Extension (will.deacon@arm.com)
  + [cefcc409c322] [2016-09-22] dt-bindings: Document devicetree binding for ARM SPE (will.deacon@arm.com)
  + [391e016fdf2e] [2017-07-07] arm64: head: Init PMSCR_EL2.{PA,PCT} when entered at EL2 without VHE (will.deacon@arm.com)
  + [0c25d023b867] [2017-09-20] arm64: sysreg: Move SPE registers and PSB into common header files (will.deacon@arm.com)
  + [5dc30368ea89] [2016-09-23] perf/core: Add PERF_AUX_FLAG_COLLISION to report colliding samples (will.deacon@arm.com)
  + [fa11e01add64] [2016-08-16] perf/core: Export AUX buffer helpers to modules (will.deacon@arm.com)
  + [fd4b46fb5b13] [2016-07-25] genirq: export irq_get_percpu_devid_partition to modules (will.deacon@arm.com)
  + [497295468df6] [2018-03-29] Don't log confusing message on reconnect by default (stfrench@microsoft.com)
  + [842303de9c49] [2018-03-21] Don't log expected error on DFS referral request (smfrench@gmail.com)
  + [3a9ff9777454] [2017-11-21] CIFS: don't log STATUS_NOT_FOUND errors for DFS (aaptel@suse.com)
  + [567aabb4027f] [2018-07-05] cifs: Fix slab-out-of-bounds in send_set_info() on SMB2 ACE setting (sbrivio@redhat.com)
  + [469a37beaeca] [2019-12-31] lib/list-test: add a test for the 'list' doubly linked list (davidgow@google.com)
  + [0e77529acd7f] [2019-09-08] Documentation: kunit: Fix verification command (sj38.park@gmail.com)
  + [2ccd0dce4f27] [2019-09-23] Documentation: kunit: add documentation for KUnit (brendanhiggins@google.com)
  + [580fed28229b] [2019-09-07] kunit: Fix '--build_dir' option (sj38.park@gmail.com)
  + [ed4c125afc16] [2019-09-23] kunit: defconfig: add defconfigs for building KUnit tests (brendanhiggins@google.com)
  + [bbe024e96af2] [2019-09-23] kunit: tool: add Python wrappers for running KUnit tests (felixguoxiuping@gmail.com)
  + [d6ec0aa5c165] [2019-09-23] kunit: fix failure to build without printk (brendanhiggins@google.com)
  + [4c29862526f7] [2019-09-23] kunit: test: add tests for KUnit managed resources (akndr41@gmail.com)
  + [9cd4bf1400eb] [2019-09-23] kunit: test: add the concept of assertions (brendanhiggins@google.com)
  + [95ff70181b0e] [2019-09-23] kunit: test: add tests for kunit test abort (brendanhiggins@google.com)
  + [4d9e7e47d7bf] [2019-09-23] kunit: test: add support for test abort (brendanhiggins@google.com)
  + [7483f6da6062] [2019-09-23] kunit: test: add initial tests (brendanhiggins@google.com)
  + [0746a4c73c05] [2019-12-31] lib: enable building KUnit in lib/ (brendanhiggins@google.com)
  + [f8e513be6929] [2019-09-23] kunit: test: add the concept of expectations (brendanhiggins@google.com)
  + [4892176b0017] [2019-09-23] kunit: test: add assertion printing library (brendanhiggins@google.com)
  + [5f96d324be43] [2019-09-23] kunit: test: add string_stream a std::stream like string builder (brendanhiggins@google.com)
  + [8d14ff2ad9cf] [2019-09-23] kunit: test: add test resource management API (brendanhiggins@google.com)
  + [2f36623a4050] [2019-09-23] kunit: test: add KUnit test runner core (brendanhiggins@google.com)
  + [ff209bc1c10e] [2020-02-03] Revert "update ENA linux driver to version 2.2.1" (anchalag@amazon.com)
  + [11c30f6c8904] [2020-01-20] update ENA linux driver to version 2.2.1 (anchalag@amazon.com)
  + [ec6bdcd72bc9] [2019-12-18] Add support for setting owner info, dos attributes, and create time (bprotopopov@hotmail.com)
  + [39bea692909d] [2018-08-28] SMB3: Backup intent flag missing from compounded ops (stfrench@microsoft.com)
  + [ac279c98d067] [2019-12-19] drivers/amazon: efa: update to 1.5.0 (luqia@amazon.com)
  + [9a09d3a8aa01] [2019-12-16] Revert "Fix the locking in dcache_readdir() and friends". (fllinden@amazon.com)
  + [bd7870ba047f] [2019-12-04] lustre: hold lock while walking changelog dev list (astroh@amazon.com)
  + [141507d9ce76] [2019-11-15] arm64: fix merge error in errata changes (fllinden@amazon.com)
  + [c3508367e0dd] [2019-11-12] nvme-pci: use atomic bitops to mark a queue enabled (hch@lst.de)
  + [8490eff28677] [2019-11-11] nvme-pci: Don't disable on timeout in reset state (keith.busch@intel.com)
  + [1092124fade8] [2019-11-11] nvme-pci: Unblock reset_work on IO failure (keith.busch@intel.com)
  + [3f70ffce0394] [2019-11-11] nvme-pci: shutdown on timeout during deletion (keith.busch@intel.com)
  + [37f48b04bce6] [2018-02-08] nvme-pci: Fix timeouts in connecting state (keith.busch@intel.com)
  + [fd9559ec6a1b] [2019-11-11] nvme: rename NVME_CTRL_RECONNECTING state to NVME_CTRL_CONNECTING (maxg@mellanox.com)
  + [2ffb2913e340] [2017-10-25] nvme: allow controller RESETTING to RECONNECTING transition (jsmart2021@gmail.com)
  + [375d1f89d01e] [2019-11-11] nvme-pci: introduce RECONNECTING state to mark initializing procedure (jianchao.w.wang@oracle.com)
  + [170dec169018] [2019-11-11] Revert "nvme/pci: Better support for disabling controller" (sblbir@amazon.com)
  + [9060557c2b59] [2019-11-04] update ena driver to version 2.1.3 (alakeshh@amazon.com)
  + [100a2f44ed3b] [2018-06-22] arm64: Avoid flush_icache_range() in alternatives patching code (will.deacon@arm.com)
  + [3c14b9d63330] [2018-09-27] arm64: pull in upstream erratum workarounds (fllinden@amazon.com)
  + [230d4d8f7d0e] [2018-03-13] arm64: kconfig: Ensure spinlock fastpaths are inlined if !PREEMPT (will.deacon@arm.com)
  + [7283eaf8e1c9] [2018-03-13] arm64: locking: Replace ticket lock implementation with qspinlock (will.deacon@arm.com)
  + [6292670d60ee] [2018-01-31] arm64: barrier: Implement smp_cond_load_relaxed (will.deacon@arm.com)
  + [b849e4fa40f3] [2018-04-26] MAINTAINERS: Add myself as a co-maintainer for the locking subsystem (will.deacon@arm.com)
  + [3ec0bcd776b8] [2018-04-26] locking/qspinlock: Use try_cmpxchg() instead of cmpxchg() when locking (will.deacon@arm.com)
  + [07463ea2024e] [2018-04-26] locking/qspinlock: Elide back-to-back RELEASE operations with smp_wmb() (will.deacon@arm.com)
  + [96830b0fdd1c] [2018-04-26] locking/qspinlock: Use smp_store_release() in queued_spin_unlock() (will.deacon@arm.com)
  + [df8ecf1bd87d] [2018-04-26] locking/qspinlock: Use smp_cond_load_relaxed() to wait for next node (will.deacon@arm.com)
  + [70801ac587bd] [2018-04-26] locking/mcs: Use smp_cond_load_acquire() in MCS spin loop (jason.low2@hp.com)
  + [5107808f055d] [2018-04-26] locking/qspinlock: Use atomic_cond_read_acquire() (will.deacon@arm.com)
  + [77718333e26d] [2018-04-26] locking/barriers: Introduce smp_cond_load_relaxed() and atomic_cond_read_relaxed() (will.deacon@arm.com)
  + [ab5f97747ff3] [2017-10-12] locking/atomic: Add atomic_cond_read_acquire() (will.deacon@arm.com)
  + [2ec7aa846b50] [2019-08-29] iommu: use config option to specify if iommu mode should be strict (fllinden@amazon.com)
  + [6f82f5df106a] [2018-09-20] iommu/arm-smmu: Support non-strict mode (robin.murphy@arm.com)
  + [b821d737cc31] [2018-09-20] iommu/io-pgtable-arm-v7s: Add support for non-strict mode (robin.murphy@arm.com)
  + [c7ce6138d1d7] [2018-09-20] iommu/arm-smmu-v3: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [4cbf3fec3386] [2018-09-20] iommu/io-pgtable-arm: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [d345f8032933] [2018-09-20] iommu: Add "iommu.strict" command line option (thunder.leizhen@huawei.com)
  + [1b05da65e555] [2018-09-20] iommu/dma: Add support for non-strict mode (thunder.leizhen@huawei.com)
  + [c145d5258849] [2018-09-20] iommu/arm-smmu-v3: Implement flush_iotlb_all hook (thunder.leizhen@huawei.com)
  + [c4bac47d8a78] [2017-09-28] iommu/io-pgtable-arm-v7s: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [05382a8a79b3] [2017-09-28] iommu/io-pgtable-arm: Convert to IOMMU API TLB sync (robin.murphy@arm.com)
  + [305b7024c5ac] [2019-03-12] irqchip/gic-v3-its: Fix comparison logic in lpi_range_cmp (linux@rasmusvillemoes.dk)
  + [0686576be18f] [2019-01-29] irqchip/gic-v3-its: Gracefully fail on LPI exhaustion (marc.zyngier@arm.com)
  + [84ecf6f13b60] [2018-08-28] irqchip/gic-v3-its: Cap lpi_id_bits to reduce memory footprint (jia.he@hxt-semitech.com)
  + [77dc2716957c] [2018-05-31] irqchip/gic-v3-its: Reduce minimum LPI allocation to 1 for PCI devices (marc.zyngier@arm.com)
  + [24e0c236cfe8] [2018-05-31] irqchip/gic-v3-its: Honor hypervisor enforced LPI range (marc.zyngier@arm.com)
  + [313d48086ff1] [2018-05-30] irqchip/gic-v3: Expose GICD_TYPER in the rdist structure (marc.zyngier@arm.com)
  + [109c24bf12a0] [2018-05-27] irqchip/gic-v3-its: Drop chunk allocation compatibility (marc.zyngier@arm.com)
  + [7e368b6bc1a3] [2018-05-27] irqchip/gic-v3-its: Move minimum LPI requirements to individual busses (marc.zyngier@arm.com)
  + [387f7f67f706] [2018-05-27] irqchip/gic-v3-its: Use full range of LPIs (marc.zyngier@arm.com)
  + [775b756a30bb] [2018-05-27] irqchip/gic-v3-its: Refactor LPI allocator (marc.zyngier@arm.com)
  + [926f33d01c77] [2018-06-22] irqchip/gic-v3-its: Only emit VSYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [d272ae80eb5b] [2018-06-22] irqchip/gic-v3-its: Only emit SYNC if targetting a valid collection (marc.zyngier@arm.com)
  + [a08ac44e3a56] [2017-07-28] irqchip/gic-v3-its: Pass its_node pointer to each command builder (marc.zyngier@arm.com)
  + [95e90adbe0e3] [2018-05-17] nvme-pci: move ->cq_vector == -1 check outside of ->q_lock (axboe@kernel.dk)
  + [36b5988f47f5] [2019-09-13] nvme/host/pci: Fix a race in controller removal (sblbir@amzn.com)
  + [ea2e2c090bd6] [2019-09-13] nvme/host/core: Allow overriding of wait_ready timeout (sblbir@amzn.com)
  + [87c4e97717d7] [2019-09-10] nvme/pci: Better support for disabling controller (sblbir@amzn.com)
  + [adcbbe0ed708] [2017-11-02] nvme: move the dying queue check from cancel to completion (hch@lst.de)
  + [2223fa6930bb] [2019-08-28] blk-mq: fix hang caused by freeze/unfreeze sequence (bob.liu@oracle.com)
  + [b38e375089f1] [2019-08-16] nvme: change namespaces_mutext to namespaces_rwsem (jianchao.w.wang@oracle.com)
  + [1dce39160c9d] [2018-09-26] block: Allow unfreezing of a queue while requests are in progress (bvanassche@acm.org)
  + [51f5c10fb213] [2019-08-16] percpu-refcount: Introduce percpu_ref_resurrect() (bvanassche@acm.org)
  + [471b39140b77] [2019-09-05] Add Amazon EFA driver version 1.4 (alakeshh@amazon.com)
  + [aac907be9fe0] [2019-04-02] block: don't show io_timeout if driver has no timeout handler (zhangweiping@didiglobal.com)
  + [4e1b4c445116] [2018-11-29] block: add io timeout to sysfs (zhangweiping@didiglobal.com)
  + [ee08af11a097] [2019-08-15] xen: Restore xen-pirqs on resume from hibernation (anchalag@amazon.com)
  + [93bc6eff0f7f] [2019-01-09] livepatch: Change unsigned long old_addr -> void *old_func in struct klp_func (pmladek@suse.com)
  + [f9feb0f2e8f4] [2018-11-07] livepatch: Replace synchronize_sched() with synchronize_rcu() (paulmck@linux.ibm.com)
  + [b339e0d1d79f] [2018-07-12] livepatch: Remove reliable stacktrace check in klp_try_switch_task() (kamalesh@linux.vnet.ibm.com)
  + [6a016a100bbe] [2018-04-16] livepatch: Allow to call a custom callback when freeing shadow variables (pmladek@suse.com)
  + [64be93108e33] [2018-04-16] livepatch: Initialize shadow variables safely by a custom callback (pmladek@suse.com)
  + [2588a0b8b457] [2017-12-21] livepatch: add locking to force and signal functions (mbenes@suse.cz)
  + [7ab79bdaed09] [2018-01-10] livepatch: Remove immediate feature (mbenes@suse.cz)
  + [6a5bf15c2cef] [2017-11-22] livepatch: force transition to finish (mbenes@suse.cz)
  + [ec2fd334c125] [2017-11-15] livepatch: send a fake signal to all blocking tasks (mbenes@suse.cz)
  + [5d5dedd1b8da] [2017-10-20] livepatch: __klp_disable_patch() should never be called for disabled patches (pmladek@suse.com)
  + [379aa3466c73] [2017-10-20] livepatch: Correctly call klp_post_unpatch_callback() in error paths (pmladek@suse.com)
  + [952e464f6631] [2017-10-13] livepatch: add transition notices (joe.lawrence@redhat.com)
  + [769dc2bb301f] [2017-10-13] livepatch: move transition "complete" notice into klp_complete_transition() (joe.lawrence@redhat.com)
  + [9a222ef5a054] [2017-10-13] livepatch: add (un)patch callbacks (joe.lawrence@redhat.com)
  + [196abc6c224a] [2017-09-14] livepatch: __klp_shadow_get_or_alloc() is local to shadow.c (jkosina@suse.cz)
  + [e04dbc028186] [2017-08-31] livepatch: introduce shadow variable API (joe.lawrence@redhat.com)
  + [c4f4b73ae5a9] [2019-08-15] Partially revert cc946adcb9e983ad9fe56ebe35f1292e111ff10e (sblbir@amzn.com)
  + [b1af9e795b82] [2019-07-11] PCI: Add ACS quirk for Amazon Annapurna Labs root ports (alisaidi@amazon.com)
  + [7e1455ffdaf3] [2019-07-11] PCI: Add Amazon's Annapurna Labs vendor ID (jonnyc@amazon.com)
  + [bc2da77c8923] [2019-06-24] linux/ena: update ENA linux driver to version 2.1.1 (fllinden@amazon.com)
  + [63878f40efe7] [2019-07-02] microvm: enable debug in case of tcp out of memory (alakeshh@amazon.com)
  + [b91a2cb11d8e] [2019-07-03] Fix microvm config dependency in Kconfig (alakeshh@amazon.com)
  + [f73cda2a8478] [2019-02-12] NFS: Remove redundant semicolon (zhangliguang@linux.alibaba.com)
  + [2aa8cd3f7bef] [2019-05-31] arm64: acpi/pci: invoke _DSM whether to preserve firmware PCI setup (fllinden@amazon.com)
  + [61d33406449f] [2019-03-28] PCI: al: Add Amazon Annapurna Labs PCIe host controller driver (jonnyc@amazon.com)
  + [2fe055adb02a] [2019-04-24] irqchip/gic-v2m: invoke from gic-v3 initialization and add acpi quirk flow (zeev@amazon.com)
  + [887da1997e20] [2019-04-03] lustre: fix ACL handling (fllinden@amazon.com)
  + [f1a298a5ec82] [2018-05-18] x86/stacktrace: Enable HAVE_RELIABLE_STACKTRACE for the ORC unwinder (jslaby@suse.cz)
  + [58bd5d245f08] [2018-05-18] x86/unwind/orc: Detect the end of the stack (jpoimboe@redhat.com)
  + [0310f1ed492b] [2018-05-18] x86/stacktrace: Do not fail for ORC with regs on stack (jslaby@suse.cz)
  + [cea53e15b36c] [2018-05-18] x86/stacktrace: Clarify the reliable success paths (jslaby@suse.cz)
  + [5f54dcb346f9] [2018-05-18] x86/stacktrace: Remove STACKTRACE_DUMP_ONCE (jslaby@suse.cz)
  + [b107f0531cae] [2018-05-18] x86/stacktrace: Do not unwind after user regs (jslaby@suse.cz)
  + [25d4dfbbc8d3] [2019-03-12] Add new config CONFIG_MICROVM to enable microvm optimized kernel (alakeshh@amazon.com)
  + [5c4cf0729143] [2019-02-19] tcp: Namespace-ify sysctl_tcp_rmem and sysctl_tcp_wmem (edumazet@google.com)
  + [6331406f8f22] [2017-11-07] net: allow per netns sysctl_rmem and sysctl_wmem for protos (edumazet@google.com)
  + [c8c9c12f1224] [2019-03-01] Config glue for lustre client. (fllinden@amazon.com)
  + [746cefcee501] [2019-03-01] Import lustre client 2.10.5 (fllinden@amazon.com)
  + [e12dc3bfed25] [2018-06-05] iomap: fsync swap files before iterating mappings (darrick.wong@oracle.com)
  + [bf5f9b738849] [2018-06-01] iomap: inline data should be an iomap type, not a flag (hch@lst.de)
  + [cfc30b9a94d3] [2018-05-16] iomap: don't allow holes in swapfiles (osandov@fb.com)
  + [f19aea7ef0d9] [2018-05-16] iomap: provide more useful errors for invalid swap files (osandov@fb.com)
  + [e7cf11ebaa85] [2018-05-10] iomap: add a swapfile activation function (darrick.wong@oracle.com)
  + [8fcdee7ca7dc] [2019-01-30] xfs, iomap: define and use the IOMAP_F_DIRTY flag in xfs (fllinden@amazon.com)
  + [4be9759b5128] [2018-08-01] xfs: only validate summary counts on primary superblock (darrick.wong@oracle.com)
  + [4021acb871aa] [2018-07-26] libxfs: add more bounds checking to sb sanity checks (billodo@redhat.com)
  + [086629fcff31] [2018-07-29] xfs: refactor superblock verifiers (darrick.wong@oracle.com)
  + [e9f7c6302bf7] [2019-01-31] xen-netfront: call netif_device_attach on resume (fllinden@amazon.com)
  + [21b1f2f16eb6] [2018-10-04] ACPI/PPTT: Handle architecturally unknown cache types (jhugo@codeaurora.org)
  + [e4c0b76604af] [2018-06-05] ACPI / PPTT: fix build when CONFIG_ACPI_PPTT is not enabled (sudeep.holla@arm.com)
  + [4f8c91a0a078] [2018-06-29] ACPI / PPTT: use ACPI ID whenever ACPI_PPTT_ACPI_PROCESSOR_ID_VALID is set (Sudeep.Holla@arm.com)
  + [1d78252b4933] [2018-05-11] arm64: topology: divorce MC scheduling domain from core_siblings (jeremy.linton@arm.com)
  + [0933917a11a0] [2018-05-11] ACPI: Add PPTT to injectable table list (jeremy.linton@arm.com)
  + [a258c57b371e] [2018-05-11] arm64: topology: enable ACPI/PPTT based CPU topology (jeremy.linton@arm.com)
  + [1c833cfe6808] [2018-05-11] arm64: topology: rename cluster_id (jeremy.linton@arm.com)
  + [7e53e1a845a8] [2018-05-11] arm64: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [c81e87052d46] [2018-05-11] drivers: base cacheinfo: Add support for ACPI based firmware tables (jeremy.linton@arm.com)
  + [af94fbd18b30] [2018-05-11] ACPI: Enable PPTT support on ARM64 (jeremy.linton@arm.com)
  + [d91098ae9022] [2018-05-11] ACPI/PPTT: Add Processor Properties Topology Table parsing (jeremy.linton@arm.com)
  + [d04c73b902b5] [2018-05-11] arm64/acpi: Create arch specific cpu to acpi id helper (jeremy.linton@arm.com)
  + [cc9fb6b5c85f] [2018-05-11] cacheinfo: rename of_node to fw_token (jeremy.linton@arm.com)
  + [76002be7c06d] [2018-05-11] drivers: base: cacheinfo: setup DT cache properties early (jeremy.linton@arm.com)
  + [3f3398a886ef] [2018-05-11] drivers: base: cacheinfo: move cache_setup_of_node() (jeremy.linton@arm.com)
  + [18f824aaacd8] [2017-11-17] ACPICA: ACPI 6.2: Additional PPTT flags (jeremy.linton@arm.com)
  + [0a4b60cf6476] [2018-07-23] arm64: acpi: fix alignment fault in accessing ACPI (takahiro.akashi@linaro.org)
  + [04f86129855f] [2018-07-02] arm64: kexec: always reset to EL2 if present (mark.rutland@arm.com)
  + [38bf94f7a618] [2018-03-08] efi/arm64: Check whether x18 is preserved by runtime services calls (ard.biesheuvel@linaro.org)
  + [7cbe02f04522] [2018-10-11] arm64: Fix /proc/iomem for reserved but not memory regions (will.deacon@arm.com)
  + [d984f6ca0230] [2018-07-23] arm64: export memblock_reserve()d regions via /proc/iomem (james.morse@arm.com)
  + [c0e4318b4b68] [2018-11-10] net: ena: Import the ENA v2 driver (2.0.2g) (alakeshh@amazon.com)
  + [950c82655bdb] [2018-11-10] xen: Only restore the ACPI SCI interrupt in xen_restore_pirqs. (fllinden@amazon.com)
  + [f8531ff0bbf1] [2018-10-26] xen: restore pirqs on resume from hibernation. (fllinden@amazon.com)
  + [4873ee887001] [2018-10-29] ACPICA: Enable sleep button on ACPI legacy wake (anchalag@amazon.com)
  + [dacbd9a304b2] [2018-10-18] block: xen-blkfront: consider new dom0 features on restore (eduval@amazon.com)
  + [d9746f41ae4e] [2017-11-30] vmxnet3: increase default rx ring sizes (skhare@vmware.com)
  + [a51afe4c6b72] [2018-04-27] x86/CPU/AMD: Derive CPU topology from CPUID function 0xB when available (suravee.suthikulpanit@amd.com)
  + [d5a7ccd0161f] [2017-09-07] sched/topology: Introduce NUMA identity node sched domain (suravee.suthikulpanit@amd.com)
  + [6a4714766c12] [2018-06-13] x86/CPU/AMD: Fix LLC ID bit-shift calculation (suravee.suthikulpanit@amd.com)
  + [093d443ccac1] [2018-04-27] x86/CPU/AMD: Calculate last level cache ID from number of sharing threads (suravee.suthikulpanit@amd.com)
  + [66749920a660] [2018-04-27] x86/CPU: Rename intel_cacheinfo.c to cacheinfo.c (bp@suse.de)
  + [82d21447f35b] [2018-05-17] x86/MCE/AMD: Read MCx_MISC block addresses on any CPU (bp@suse.de)
  + [b813f3fee384] [2018-08-15] blk-wbt: Avoid lock contention and thundering herd issue in wbt_wait (anchalag@amazon.com)
  + [e964663021b5] [2018-01-12] blk-mq: simplify queue mapping & schedule with each possisble CPU (hch@lst.de)
  + [78becaf19100] [2018-04-09] x86: tsc: avoid system instability in hibernation (eduval@amazon.com)
  + [5c63ab6d3241] [2018-06-05] xen-blkfront: Fixed blkfront_restore to remove a call to negotiate_mq (anchalag@amazon.com)
  + [631230eba05f] [2018-03-24] KVM: X86: Fix setup the virt_spin_lock_key before static key get initialized (wanpengli@tencent.com)
  + [4118ce6d7a00] [2017-10-28] x86/paravirt: Set up the virt_spin_lock_key after static keys get initialized (douly.fnst@cn.fujitsu.com)
  + [f4648c644c12] [2018-02-13] KVM: X86: Choose qspinlock when dedicated physical CPUs are available (wanpengli@tencent.com)
  + [da36ef371ba5] [2018-02-13] KVM: Introduce paravirtualization hints and KVM_HINTS_DEDICATED (wanpengli@tencent.com)
  + [9569cccf6578] [2017-09-06] locking/paravirt: Use new static key for controlling call of virt_spin_lock() (jgross@suse.com)
  + [6ba39f9e5ae4] [2018-03-27] Revert "xen: dont fiddle with event channel masking in suspend/resume" (anchalag@amazon.com)
  + [8766def8645a] [2018-01-18] ACPI: SPCR: Make SPCR available to x86 (prarit@redhat.com)
  + [b5f204380315] [2016-04-26] xen-blkfront: add 'persistent_grants' parameter (aliguori@amazon.com)
  + [a1cb3d4c4e9e] [2017-03-10] xen-blkfront: resurrect request-based mode (kamatam@amazon.com)
  + [b4b42bd7ff11] [2017-11-02] Not-for-upstream: PM / hibernate: Speed up hibernation by batching requests (cyberax@amazon.com)
  + [1e5305541413] [2017-10-27] PM / hibernate: update the resume offset on SNAPSHOT_SET_SWAP_AREA (cyberax@amazon.com)
  + [38aad6be0bfa] [2017-08-24] x86/xen: close event channels for PIRQs in system core suspend callback (kamatam@amazon.com)
  + [f74252267c2a] [2017-08-24] xen/events: add xen_shutdown_pirqs helper function (kamatam@amazon.com)
  + [028516ca8f6a] [2017-07-21] x86/xen: save and restore steal clock (kamatam@amazon.com)
  + [d8c70078418d] [2017-07-13] xen/time: introduce xen_{save,restore}_steal_clock (kamatam@amazon.com)
  + [18c5e11bfd12] [2017-01-09] xen-netfront: add callbacks for PM suspend and hibernation support (kamatam@amazon.com)
  + [a7b9bc479c2c] [2017-06-08] xen-blkfront: add callbacks for PM suspend and hibernation (kamatam@amazon.com)
  + [228e4dc705b5] [2017-02-11] x86/xen: add system core suspend and resume callbacks (kamatam@amazon.com)
  + [6f7a392fd493] [2018-02-22] x86/xen: Introduce new function to map HYPERVISOR_shared_info on Resume (anchalag@amazon.com)
  + [3a7ab2bfa5f4] [2017-07-13] xenbus: add freeze/thaw/restore callbacks support (kamatam@amazon.com)
  + [1e92680c4923] [2017-07-13] xen/manage: introduce helper function to know the on-going suspend mode (kamatam@amazon.com)
  + [21968275f1e8] [2017-07-12] xen/manage: keep track of the on-going suspend mode (kamatam@amazon.com)
  + [08bb3f313e19] [2018-02-27] Importing Amazon ENA driver 1.5.0 into amazon-4.14.y/master. (vallish@amazon.com)
  + [6c13e9105768] [2018-02-12] drivers/amazon: introduce AMAZON_ENA_ETHERNET (vallish@amazon.com)
  + [92f9ce7f550b] [2018-02-12] drivers/amazon: add network device drivers support (vallish@amazon.com)
  + [79e9e93abb3f] [2018-02-12] drivers: introduce AMAZON_DRIVER_UPDATES (vallish@amazon.com)
  + [7b39a13aba72] [2017-10-27] not-for-upstream: testmgr config changes to enable FIPS boot (alakeshh@amazon.com)
  + [f916b88bad14] [2017-09-19] nvme: update timeout module parameter type (vallish@amazon.com)
  + [a6ea7aea7dae] [2015-12-08] force perf to use /usr/bin/python instead of /usr/bin/python2 (kamatam@amazon.com)
  + [4f9ba930a3da] [2013-02-13] bump default tcp_wmem from 16KB to 20KB (gafton@amazon.com)
  + [fd21e83fe10c] [2016-01-26] bump the default TTL to 255 (kamatam@amazon.com)
  + [294334979320] [2012-02-10] scsi: sd_revalidate_disk prevent NULL ptr deref (kernel-team@fedoraproject.org)
  + [4568703db074] [2008-10-06] kbuild: AFTER_LINK (roland@redhat.com)

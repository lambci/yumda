...
# Documentation
install -m0644 doc/COPYING $RPM_BUILD_ROOT%{_docdir}/%{name}-%{version}
...
rm -rf $RPM_BUILD_ROOT%{_datadir}/ghostscript/%{version}/Resource/Font
...
rm -f $RPM_BUILD_ROOT%{_datadir}/ghostscript/%{version}/Resource/Init/gs_init.ps.orig

MAIN_PWD=`pwd`
(cd $RPM_BUILD_ROOT; find .%{_datadir}/ghostscript/%{version}/Resource -type f | \
...
mkdir -p $RPM_BUILD_ROOT%{_datadir}/ghostscript/%{version}/
mv $RPM_BUILD_ROOT%{_docdir}/ghostscript/examples $RPM_BUILD_ROOT%{_datadir}/ghostscript/%{version}/

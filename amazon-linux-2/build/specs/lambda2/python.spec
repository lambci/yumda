...
if [ -f Tools/pynche/README ]; then mv Tools/pynche/README Tools/pynche/README.pynche; fi
...
%exclude %{_includedir}/python%{pybasever}/*.h
...
%exclude %{_libdir}/libpython%{pybasever}.so
%exclude %{_sysconfdir}/rpm/macros.python
%exclude %{_sysconfdir}/rpm/macros.python2
...
%exclude %{pylibdir}/bsddb/test
%exclude %{pylibdir}/ctypes/test
%exclude %{pylibdir}/distutils/tests
%exclude %{pylibdir}/email/test
%exclude %{pylibdir}/json/tests
%exclude %{pylibdir}/lib2to3/tests
...
%exclude %{dynload_dir}/_testcapimodule.so

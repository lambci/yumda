...
sed -i 's/L+/#/' %{buildroot}%{_libdir}/tmpfiles.d/etc.conf
...
%exclude %{_libdir}/*.so
%exclude %{_libdir}/tmpfiles.d
%exclude %{_libdir}/udev
%exclude %{_libdir}/dracut
%exclude %{_libdir}/kernel
%exclude %{_libdir}/libnss_resolve.so.2
%exclude %{_libdir}/rpm
%exclude %{_libdir}/sysctl.d

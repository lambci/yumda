...
Name: libXrandr
Version: 1.4.1
Release: 2.1%{?gitdate:.%{gitdate}git%{gitversion}}%{?_buildid}%{?dist}
License: MIT
...
- import source package RHEL6/libXrandr-1.4.0-1.el6
...
- import source package RHEL6/libXrandr-1.3.0-4.el6

* Fri May 7 2010 Cristian Gafton <gafton@amazon.com>
- import source package RHEL5/libXrandr-1.1.1-3.3
- import source package RHEL5/libXrandr-1.1.1-3.1
- added submodule prep for package libXrandr

...
%if 0%{?amzn} >= 2
%global is_compat_pkg 1
%else
%global is_compat_pkg 0
%endif
...
%if 0%{?amzn} >= 2
%global multilib_64_archs noarch
%else
...
# Overide some builds we don't need for a compat package
%if %{is_compat_pkg}
%global build_libgcc 0
%global build_libstdcplusplus 0
%global build_cpp 0
...
%global build_libatomic 0
%global build_libitm 0
%global build_libmudflap 0
%global build_plugin_devel 0
%else
%global build_libgcc 1
%global build_libstdcplusplus 1
%global build_cpp 1
%global build_libgomp 1
%global build_libmudflap 1
%global build_plugin_devel 1
%endif
...
../configure CFLAGS="%{optflags} -std=gnu99" --prefix=%{_prefix} --mandir=%{_mandir} --infodir=%{_infodir}
make %{?_smp_mflags}
...
rm -f %{buildroot}%{_infodir}/libgomp.info*
...
%if %{build_fortran}
%if %{is_compat_pkg}
%post libgfortran -p /sbin/ldconfig

%postun libgfortran -p /sbin/ldconfig
%else

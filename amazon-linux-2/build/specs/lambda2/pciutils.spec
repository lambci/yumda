...
make SHARED="yes" LIBKMOD="yes" ZLIB="no" STRIP="" OPT="$RPM_OPT_FLAGS" PREFIX="%{_prefix}" LIBDIR="%{_libdir}" \
  IDSDIR="%{_prefix}/share/hwdata" PCI_IDS="pci.ids" %{?_smp_mflags}
...
%install
install -d $RPM_BUILD_ROOT/{sbin,%{_sbindir},%{_libdir}}

...
%if 0%{?amzn}
# amzn2 rpm macros don't define _metainfodir
...
Patch10004: 10004-bpo-34155-Dont-parse-domains-containing-at-GH-13079.patch
%endif
...
Conflicts: python2-tools < 2.7.16-5
Conflicts: python-tools < 2.7.16-5
...
# amzn2 -tools has idle, so claim it
%endif
...
# amzn2 already installed this as "%{_libdir}/%{py_INSTSONAME_debug}"
%endif

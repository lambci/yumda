...
- remove -lXau workaround

* Wed Jul 21 2010 Cristian Gafton <gafton@amazon.com>
- update build requires
- fix compile against libXau

* Fri Jul 9 2010 Cristian Gafton <gafton@amazon.com>
- import source package RHEL6/libXpm-3.5.8-2.el6

* Fri May 7 2010 Cristian Gafton <gafton@amazon.com>
- import source package RHEL5/libXpm-3.5.5-3
- added submodule prep for package libXpm

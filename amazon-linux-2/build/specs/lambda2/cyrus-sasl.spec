...
install -m755 -d $RPM_BUILD_ROOT%{_sysconfdir}/rc.d/init.d $RPM_BUILD_ROOT%{_sysconfdir}/sysconfig
install -m644 -p %{SOURCE9} $RPM_BUILD_ROOT%{_sysconfdir}/sysconfig/saslauthd
...
%exclude %{_plugindir2}/*.la
%exclude %{_plugindir2}/libotp.*
